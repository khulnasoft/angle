...
urls: {
	...
	aws_cloudwatch_logs_sink_source:            "\(angle_repo)/blob/master/src/sinks/aws_cloudwatch_logs/"
	...
	cloudsmith_apt:                             "https://cloudsmith.io/~timber/repos/angle/setup/#formats-deb"
	cloudsmith_yum:                             "https://cloudsmith.io/~timber/repos/angle/setup/#formats-rpm"
	community_id_spec:                          "https://github.com/corelight/community-id-spec"
	console:                                    "\(wikipedia)/wiki/System_console"
	contributing:                               "\(angle_repo)/blob/master/CONTRIBUTING.md#setup"
	...
	datadog_agent_doc:                          "\(datadog_docs)/agent/angle_aggregation/"
	...
	default_configuration:                      "\(angle_repo)/blob/master/config/angle.yaml"
	...
	docker_hub_angle:                          "\(docker_hub)/r/timberio/angle"
	...
	dockerfile:                                 "\(angle_repo)/blob/master/Dockerfile"
	...
	event_proto:                                "\(angle_repo)/blob/master/lib/angle-core/proto/event.proto"
	...
	issue_1694:                                 "\(angle_repo)/issues/1694"
	...
	kubernetes_example_daemonset:               "\(angle_repo)/blob/master/config/kubernetes/angle-daemonset.yaml"
	...
	leveldb_sys_3:                              "\(github)/khulnasoft/leveldb-sys/tree/v3.0.0"
	...
	log_event_source:                           "\(angle_repo)/blob/master/src/event/"
	...
	metric_event_source:                        "\(angle_repo)/blob/master/src/event/metric.rs"
	...
	musl_builder_docker_image:                  "\(angle_repo)/blob/master/scripts/ci-docker-images/builder-x86_64-unknown-linux-musl/Dockerfile"
	native_proto_schema:                        "\(angle_repo)/blob/master/lib/angle-core/proto/event.proto"
	native_json_schema:                         "\(angle_repo)/blob/master/lib/codecs/tests/data/native_encoding/schema.cue"
	nats:                                       "https://nats.io/"
	nats_rs:                                    "\(github)/nats-io/nats.rs"
	new_bug_report:                             "\(angle_repo)/issues/new?labels=type%3A+bug"
	new_feature_request:                        "\(angle_repo)/issues/new?labels=type%3A+new+feature"
	...
	new_security_report:                        "\(angle_repo)/issues/new?labels=domain%3A+security"
	new_sink:                                   "\(angle_repo)/issues/new?labels=type%3A+new+feature"
	new_source:                                 "\(angle_repo)/issues/new?labels=type%3A+new+feature"
	new_target:                                 "\(angle_repo)/issues/new?labels=type%3A+task&labels=domain%3A+operations"
	new_transform:                              "\(angle_repo)/issues/new?labels=type%3A+new+feature"
	...
	rfc_2064:                                   "\(angle_repo)/blob/master/rfcs/2020-03-17-2064-event-driven-observability.md"
	...
	specs_instrumentation:                      "\(angle_repo)/blob/master/docs/specs/instrumentation.md)"
	...
	angle_agent_role:                          "/docs/setup/deployment/roles/#agent"
	angle_aggregator_role:                     "/docs/setup/deployment/roles/#aggregator"
	angle_aws_s3_sink:                         "/docs/reference/configuration/sinks/aws_s3/"
	angle_aws_s3_sink_auth:                    "/docs/reference/configuration/sinks/aws_s3/#auth"
	angle_aws_s3_sink_how_it_works:            "/docs/reference/configuration/sinks/aws_s3/#how-it-works"
	angle_blog:                                "/blog/"
	angle_buffering_model:                     "/docs/about/under-the-hood/architecture/buffering-model/"
	angle_bug_issues:                          "\(angle_repo)/issues?q=is%3Aopen+is%3Aissue+label%3A%22type%3A+bug%22"
	angle_changelog:                           "\(angle_repo)/blob/master/CHANGELOG.md"
	angle_chat:                                "https://chat.angle.khulnasoft.com"
	angle_code_of_conduct:                     "\(angle_repo)/blob/master/CODE_OF_CONDUCT.md"
	angle_community:                           "/community/"
	angle_components:                          "/components/"
	angle_configuration:                       "/docs/reference/configuration/"
	angle_configuration_global:                "/docs/reference/configuration/global-options"
	angle_data_model:                          "/docs/about/under-the-hood/architecture/data-model/"
	angle_debian_source_files:                 "\(angle_repo)/tree/master/distribution/debian"
	angle_dedupe_transform:                    "/docs/reference/configuration/transforms/dedupe/"
	angle_docker_logs_source:                  "/docs/reference/configuration/sources/docker_logs/"
	angle_docker_source_files:                 "\(angle_repo)/tree/master/distribution/docker"
	angle_docs:                                "/docs/"
	angle_download:                            "/releases/latest/download/"
	angle_download_nightly:                    "/releases/nightly/download/"
	angle_enriching_transforms:                "/components/?functions%5B%5D=enrich"
	angle_file_source:                         "/docs/reference/configuration/sources/file/"
	angle_exec_source:                         "/docs/reference/configuration/sources/exec"
	angle_file_source:                         "/docs/reference/configuration/sources/file/"
	angle_gcs_sink_how_it_works:               "/docs/reference/configuration/sinks/gcp_cloud_storage/#how-it-works"
	angle_generate_arguments_issue:            "\(angle_repo)/issues/1966"
	angle_guides:                              "/guides/"
	angle_glibc_benchmarks:                    "\(angle_repo)/issues/2313"
	angle_highlights:                          "/highlights/"
	angle_host_metrics_source:                 "/docs/reference/configuration/sources/host_metrics"
	angle_http_auth_token:                     "/docs/reference/configuration/sinks/http/#token"
	angle_homebrew:                            "/docs/setup/installation/package-managers/homebrew"
	angle_homebrew_source_files:               "\(github)/khulnasoft/homebrew-brew/blob/master/Formula/angle.rb"
	angle_http_source:                         "/docs/reference/configuration/sources/http/"
	angle_initd_service:                       "\(angle_repo)/blob/master/distribution/init.d/angle"
	angle_installer:                           "https://sh.angle.khulnasoft.com"
	angle_issues:                              "\(angle_repo)/issues"
	angle_journald_source:                     "/docs/reference/configuration/sources/journald/"
	angle_kubernetes_logs_source:              "/docs/reference/configuration/sources/kubernetes_logs/"
	angle_level_up:                            "/guides/level-up/"
	angle_log:                                 "/docs/about/under-the-hood/architecture/data-model/log"
	angle_log_data_types:                      "/docs/about/under-the-hood/architecture/data-model/log/#types"
	angle_lua_rfc:                             "\(angle_repo)/blob/master/rfcs/2020-03-06-1999-api-extensions-for-lua-transform.md"
	angle_log_schema:                          "/docs/reference/configuration/global-options/#log_schema"
	angle_lua_transform:                       "/docs/reference/configuration/transforms/lua/"
	angle_metric:                              "/docs/about/under-the-hood/architecture/data-model/metric"
	angle_monitoring:                          "/docs/administration/monitoring"
	angle_msi_source_files:                    "\(angle_repo)/tree/master/distribution/msi"
	angle_new_relic_sink:                      "/docs/reference/configuration/sinks/new_relic/"
	angle_nightly_builds:                      "https://packages.timber.io/angle/nightly/latest/"
	angle_nix_package:                         "\(github)/NixOS/nixpkgs/blob/master/pkgs/tools/misc/angle/default.nix"
	angle_packages_root:                       "https://packages.timber.io"
	angle_parsing_transforms:                  "/components/?functions%5B%5D=parse"
	angle_performance:                         "\(angle_repo)/#performance"
	angle_privacy_policy:                      "\(angle_repo)/blob/master/PRIVACY.md"
	angle_programmable_transforms:             "/components/?functions%5B%5D=program"
	angle_pull_requests:                       "\(angle_repo)/pulls"
	angle_readme:                              "\(angle_repo)/blob/master/README.md"
	angle_receiving_sources:                   "/components/?functions%5B%5D=receive"
	angle_releases:                            "/releases/latest/"
	angle_reduce_transform:                    "/docs/reference/configuration/transforms/reduce"
	angle_release_policy:                      "https://github.com/khulnasoft/angle/blob/master/docs/RELEASING.md"
	angle_remap_transform:                     "/docs/reference/configuration/transforms/remap/"
	angle_remap_transform_multiple:            "/docs/reference/configuration/transforms/remap/#emitting-multiple-log-events"
	angle_repo:                                "\(github)/khulnasoft/angle"
	angle_roles:                               "/docs/setup/deployment/roles"
	angle_route_transform:                     "/docs/reference/configuration/transforms/route"
	angle_rpm_source_files:                    "\(angle_repo)/tree/master/distribution/rpm"
	angle_security_policy:                     "\(angle_repo)/security/policy"
	angle_semantic_yml:                        "\(angle_repo)/blob/master/.github/semantic.yml"
	angle_sink:                                "/docs/reference/configuration/sinks/angle"
	angle_sinks:                               "/docs/reference/configuration/sinks"
	angle_sink_http_batch:                     "/docs/reference/configuration/sinks/http/#batch"
	angle_sink_kafka_sasl:                     "/docs/reference/configuration/sources/kafka/#sasl"
	angle_splunk_hec_metrics_sink:             "/docs/reference/configuration/sinks/splunk_hec_metrics"
	angle_datadog_events_sink:                 "/docs/reference/configuration/sinks/datadog_events"
	angle_azure_blob_sink:                     "/docs/reference/configuration/sinks/azure_blob"
	angle_redis_sink:                          "/docs/reference/configuration/sinks/redis"
	angle_dnstap_source:                       "/docs/reference/configuration/sources/dnstap"
	angle_eventstoredb_metrics_source:         "/docs/reference/configuration/sources/eventstoredb_metrics"
	angle_fluent_source:                       "/docs/reference/configuration/sources/fluent"
	angle_logstash_source:                     "/docs/reference/configuration/sources/logstash"
	angle_nats_source:                         "/docs/reference/configuration/sources/nats"
	angle_rfc_8381:                            "\(angle_repo)/blob/master/rfcs/2021-08-29-8381-vrl-iteration-support.md"
	angle_socket_source:                       "/docs/reference/configuration/sources/socket"
	angle_source:                              "/docs/reference/configuration/sources/angle"
	angle_sources:                             "/docs/reference/configuration/sources"
	angle_stars:                               "\(angle_repo)/stargazers"
	angle_stdin_source:                        "/docs/reference/configuration/sources/stdin"
	angle_systemd_file:                        "\(angle_repo)/blob/master/distribution/systemd/angle.service"
	angle_test_harness:                        "\(angle_repo)-test-harness/"
	angle_topologies:                          "/docs/setup/deployment/topologies"
	angle_transforms:                          "/docs/reference/configuration/transforms"
	angle_twitter:                             "https://twitter.com/khulnasoft"
	angle_unit_tests:                          "\(angle_configuration)/unit-tests"
	angle_version_branches:                    "\(angle_repo)/branches/all?query=v"
	...
	vote_feature:                               "\(angle_repo)/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc+label%3A%22Type%3A+New+Feature%22"

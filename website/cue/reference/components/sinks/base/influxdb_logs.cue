...
base: components: sinks: influxdb_logs: configuration: {
	...
	bucket: {
		description: """
			...
			"""
		required: true
		type: string: examples: ["angle-bucket", "4d2225e4d3d49f75"]
	}
	consistency: {
		description: """
	...
	database: {
		description: """
			...
			"""
		required: true
		type: string: examples: ["angle-database", "iot-store"]
	}
	encoding: {
	...
	measurement: {
		...
		required:    false
		type: string: examples: ["angle-logs"]
	}
	message_key: {
		description: """
	...
	username: {
		description: """
			...
			"""
		required: false
		type: string: examples: ["todd", "angle-source"]
	}
}

...
base: components: sinks: gcp_cloud_storage: configuration: {
			...
			codec: {
				...
				type: string: enum: {
					...
					logfmt: """
						...
						"""
					native: """
						Encodes an event in the [native Protocol Buffers format][angle_native_protobuf].
						...
						"""
					native_json: """
						Encodes an event in the [native JSON format][angle_native_json].
				...
				type: object: options: {
					desc_file: {
						description: """
																...
																"""
						required: true
						type: string: examples: ["/etc/angle/protobuf_descriptor_set.desc"]
					}
					message_type: {
			...
			concurrency: {
				...
				type: {
					string: {
						...
						enum: {
							adaptive: """
															Concurrency will be managed by Angle's [Adaptive Request Concurrency][arc] feature.

															[arc]: https://angle.khulnasoft.com/docs/about/under-the-hood/networking/arc/
															"""
							none: """
	...
	timezone: {
		description: """
			...
			This can refer to any valid timezone as defined in the [TZ database][tzdb], or "local" which refers to the system local timezone. It will default to the [globally configured timezone](https://angle.khulnasoft.com/docs/reference/configuration/global-options/#timezone).

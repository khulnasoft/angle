	...
	how_it_works: {
		decentralized_deployments: {
			...
			body: """
				...
				Angle is deployed in a decentralized setup then there is
				the possibility that logs might get rejected due to data
				races between Angle instances. To avoid this we suggest
				either assigning each Angle instance with a unique label
				or deploying a centralized Angle which will ensure no logs

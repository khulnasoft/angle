...
components: sources: internal_metrics: {
	...
	description: """
		Exposes Angle's own internal metrics, allowing you to collect, process,
		and route Angle's internal metrics just like other metrics.
		"""
	...
	output: metrics: {
		...
		_internal_metrics_tags: {
			pid: {
				description: "The process ID of the Angle instance."
				required:    false
				examples: ["4232"]
			}
			host: {
				description: "The hostname of the system Angle is running on."
				required:    false
		...
		api_started_total: {
			description:       "The number of times the Angle GraphQL API has been started."
			type:              "counter"
			default_namespace: "angle"
		...
		quit_total: {
			description:       "The total number of times the Angle instance has quit."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		reloaded_total: {
			description:       "The total number of times the Angle instance has been reloaded."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		started_total: {
			description:       "The total number of times the Angle instance has been started."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		stopped_total: {
			description:       "The total number of times the Angle instance has been stopped."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		...
		containers_unwatched_total: {
			description:       "The total number of times Angle stopped watching for container logs."
			type:              "counter"
			default_namespace: "angle"
			tags:              _component_tags
		}
		containers_watched_total: {
			description:       "The total number of times Angle started watching for container logs."
			type:              "counter"
			default_namespace: "angle"
			tags:              _component_tags
		}
		...
		component_received_events_count: {
			description: """
				A histogram of the number of events passed in each internal batch in Angle's internal topology.

				Note that this is separate than sink-level batching. It is mostly useful for low level debugging
				performance issues in Angle due to small internal batches.
				"""
			type:              "histogram"
			default_namespace: "angle"
			tags:              _component_tags & {
		...
		files_added_total: {
			description:       "The total number of files Angle has found to watch."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags & {
				file: _file
		...
		files_resumed_total: {
			description:       "The total number of times Angle has resumed watching a file."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags & {
				file: _file
		...
		files_unwatched_total: {
			description:       "The total number of times Angle has stopped watching a file."
			type:              "counter"
			default_namespace: "angle"
			tags:              _internal_metrics_tags & {
				file: _file
		...
		open_connections: {
			description:       "The number of current open connections to Angle."
			type:              "gauge"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		protobuf_decode_errors_total: {
			description:       "The total number of [Protocol Buffers](\(urls.protobuf)) errors thrown during communication between Angle instances."
			type:              "counter"
			default_namespace: "angle"
			tags:              _component_tags
		}
		...
		stale_events_flushed_total: {
			description:       "The number of stale events that Angle has flushed."
			type:              "counter"
			default_namespace: "angle"
			tags:              _component_tags
		}
		...
		uptime_seconds: {
			description:       "The total number of seconds the Angle instance has been up."
			type:              "gauge"
			default_namespace: "angle"
			tags:              _internal_metrics_tags
		}
		...
		build_info: {
			description:       "Has a fixed value of 1.0. Contains build information such as Rust and Angle versions."
			type:              "gauge"
			default_namespace: "angle"
			tags:              _internal_metrics_tags & {
				debug: {
					description: "Whether this is a debug build of Angle"
					required:    true
				}
				version: {
		...
		_component_kind: {
			description: "The Angle component kind."
			required:    true
			enum: {
				"sink":      "Angle sink components"
				"source":    "Angle source components"
				"transform": "Angle transform components"
			}
		}
		_component_id: {
			description: "The Angle component ID."
			required:    true
			examples: ["my_source", "my_sink"]
		}
		_component_type: {
			description: "The Angle component type."
			required:    true
	...
	how_it_works: {
		unique_series: {
			title: "Sending metrics from multiple Angle instances"
			body: """
				When sending `internal_metrics` from multiple Angle instances
				to the same destination, you will typically want to tag the
				metrics with a tag that is unique to the Angle instance sending

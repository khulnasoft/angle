...
components: sources: host_metrics: {
	...
	support: {
		...
		warnings: [
			"""
				When angle is run under kubernetes, you may experience an error when loading the partition usage data:
				...
				This workaround is included by default in the Helm chart distributed with Angle.
				""",
		]
	}

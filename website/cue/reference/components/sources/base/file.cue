...
base: components: sources: file: configuration: {
	...
	data_dir: {
		description: """
			...
			"""
		required: false
		type: string: examples: ["/var/local/lib/angle/"]
	}
	encoding: {
	...
	include: {
		description: "Array of file patterns to include. [Globbing](https://angle.khulnasoft.com/docs/reference/configuration/sources/file/#globbing) is supported."
		required:    true

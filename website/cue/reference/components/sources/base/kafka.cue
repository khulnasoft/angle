...
base: components: sources: kafka: configuration: {
	...
	decoding: {
		...
		type: object: options: {
				...
				type: string: {
					...
					enum: {
						...
						json: """
															...
															"""
						native: """
															Decodes the raw bytes as [native Protocol Buffers format][angle_native_protobuf].
															...
															"""
						native_json: """
															Decodes the raw bytes as [native JSON format][angle_native_json].
			...
			native_json: {
				description:   "Angle's native JSON-specific decoding options."

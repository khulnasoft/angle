	...
	support: {
		requirements: [
			"""
				...
				to solve TLS termination by fronting Angle with a load balancer or
	...
	how_it_works: {
		structured_events: {
			...
			body:  """
				...
				1. Deploy angle with a publicly exposed HTTP endpoint using
				...
				2. Create a Kinesis Firehose delivery stream in the region
				   ...
				   ingest.
				3. Set the stream to forward to your Angle instance via its

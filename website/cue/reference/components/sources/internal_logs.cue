...
components: sources: internal_logs: {
	title:       "Internal Logs"
	description: "The internal logs source exposes all log and trace messages emitted by the running Angle instance."
				...
				type: object: {
					...
					options: {
						...
						module_path: {
							...
							required:    true
							type: string: {
								examples: ["angle::internal_events::heartbeat"]
							}
						}
						target: {
	...
	how_it_works: {
		limited_logs: {
			...
			body: """
				At startup, the selection of log messages generated by Angle is determined by a
				combination of the `ANGLE_LOG` environment variable and the `--quiet` and `--verbose`

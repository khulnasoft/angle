...
components: transforms: [Name=string]: {
	_remap_deprecation_notice: """
		This transform has been deprecated in favor of the [`remap`](\(urls.angle_remap_transform))
		transform, which enables you to use [Angle Remap Language](\(urls.vrl_reference)) (VRL for short) to

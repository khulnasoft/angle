...
components: transforms: lua: {
	...
	support: {
		...
		warnings: [
			"""
			The `lua` transform is ~60% slower than the [`remap` transform](\(urls.angle_remap_transform)); we
	...
	how_it_works: {
		event_data_model: {
			...
			body:  """
				...
				and follow Angle's data model exactly. Please refer to
				Angle's [data model reference](\(urls.angle_data_model)) for the event
				schema. How Angle's types map to Lua's type are covered below.
				"""
			sub_sections: [
				{
					title: "Type Mappings"
					body:  """
						The correspondence between Angle's [data types](\(urls.angle_log_data_types)) and Lua data type is summarized
						by the following table:

						| Angle Type                                         | Lua Type                        | Comment                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
						|:----------------------------------------------------|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
						| [`String`](\(urls.angle_log)#strings)       | [`string`](\(urls.lua_string))     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
						| [`Integer`](\(urls.angle_log)#integers)     | [`integer`](\(urls.lua_integer))   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
						| [`Float`](\(urls.angle_log)#floats)         | [`number`](\(urls.lua_number))     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
						| [`Boolean`](\(urls.angle_log)#booleans)     | [`boolean`](\(urls.lua_boolean))   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
						| [`Timestamp`](\(urls.angle_log)#timestamps) | [`table`](\(urls.lua_table))       | There is no dedicated timestamp type in Lua. Timestamps are represented as tables using the convention defined by [`os.date`](\(urls.lua_os_date)) and [`os.time`](\(urls.lua_os_time)). The table representation of a timestamp contains the fields `year`, `month`, `day`, `hour`, `min`, `sec`, `nanosec`, `yday`, `wday`, and `isdst`. If such a table is passed from Lua to Angle, the fields `yday`, `wday`, and `isdst` can be omitted. In addition to the `os.time` representation, Angle supports sub-second resolution with a `nanosec` field in the table. |
						| [`Null`](\(urls.angle_log)#null-values)     | empty string                    | In Lua setting the value of a table field to `nil` means deletion of this field. In addition, the length operator `#` does not work in the expected way with sequences containing nulls. Because of that `Null` values are encoded as empty strings.                                                                                                                                                                                                                                                                                                               |
						| [`Map`](\(urls.angle_log)#maps)             | [`table`](\(urls.lua_table))       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
						| [`Array`](\(urls.angle_log)#arrays)         | [`sequence`](\(urls.lua_sequence)) | Sequences are a special case of tables. Indexes start from 1, following the Lua convention.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
						"""
				},
			]
		}
		...
		search_dirs: {
			...
			body:  """
				Angle provides a `search_dirs` option that allows you to specify

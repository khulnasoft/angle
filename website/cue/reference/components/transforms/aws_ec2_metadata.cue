...
components: transforms: aws_ec2_metadata: {
	...
	support: {
		...
		warnings: [
			"""
				Do not enable this transform if you are running Angle as an Aggregator, tags will be sourced from the Aggregator node's metadata server and not the client's.
				""",
		]
	}

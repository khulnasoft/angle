...
base: components: sinks: configuration: {
				...
				type: string: {
					...
					enum: {
						disk: """
														...
														be lost if Angle is restarted forcefully or crashes.
						...
						memory: """
														...
														This is more performant, but less durable. Data will be lost if Angle is restarted
	...
	healthcheck: {
		...
		type: object: options: {
			enabled: {
				description: "Whether or not to check the health of the sink when Angle starts up."
				required:    false
	...
	inputs: {
		description: """
			...
			[sources]: https://angle.khulnasoft.com/docs/reference/configuration/sources/
			[transforms]: https://angle.khulnasoft.com/docs/reference/configuration/transforms/
			[configuration]: https://angle.khulnasoft.com/docs/reference/configuration/
			"""
		required: true

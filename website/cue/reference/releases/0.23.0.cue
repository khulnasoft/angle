...
releases: "0.23.0": {
	...
	whats_next: [
		{
			...
			description: """
				We plan to focus on adding Open Telemetry support to Angle in the form of an `opentelemetry` source and sink in
				Q3 (starting from the [contribution](https://github.com/khulnasoft/angle/pull/13320) from
				[caibirdme](https://github.com/caibirdme))!.
				"""
		},
		{
			title: "Improving Angle's delivery guarantees"
			description: """
				Another focus of Q3 for us will be shoring up Angle's delivery guarantees to eliminate the possibilities
				of Angle unintentionally dropping data once it has accepted it (when end-to-end acknowledgements are
	...
	description: """
		The Angle team is pleased to announce version 0.23.0!
	...
	changelog: [
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle now has a mechanism for loading secrets into configuration by executing an external program. See
		...
		},
		{
			...
			description: """
				...
				>= 0.11.0 of the helm chart or adding the `node` resource to the allowed actions for the Angle
				pod. See the [upgrade
		...
		},
		{
			...
			scopes: ["releasing"]
			description: """
				The Angle SystemD unit file installed by the Debian package no longer automatically starts Angle. This
		...
		},
		{
			...
			scopes: ["angle source"]
			description: """
				The `angle` source now reports the correct number of bytes received in `component_received_bytes_total`.
				"""
			pr_numbers: [12910]
		},
		{
			...
			description: """
				...
				seconds, to allow Angle to fail more quickly if the IMDSv2 is unavailable. This can be configured via
		...
		},
		{
			...
			description: """
				...
				See the [originating
				RFC](https://github.com/khulnasoft/angle/blob/78b0a76c8826d62ad71a2b323e27dbb3b322ed09/rfcs/2021-08-22-7204-vrl-error-diagnostic-improvements.md)
		...
		},
		{
			...
			description: """
				The `splunk_hec_logs` sink now has a new option to configure Angle to not set a timestamp on the event
		...
		},
		{
			...
			description: """
				Angle's parsing of Syslog messages now preserves empty structured data elements rather than dropping
		...
		},
		{
			...
			description: """
				...
				match other Angle configuration options that take a number of seconds. The original names are aliased,
		...
		},
		{
			...
			description: """
				...
				consumers within Angle to a maximum of the newly added `max_concurrency` option (defaults to
				10).
				"""
			pr_numbers: [13240]
		},
		...
		},
		{
			...
			description: """
				Angle no longer becomes unresponsive when receiving more than two SIGHUPs, instead it will warn when
		...
		},
		{
			...
			breaking: true
			description: """
				Due to changes to the [tool we use for cross-compiling Angle](https://github.com/cross-rs/cross),
				support for operating systems with old versions of `libc` and `libstdc++` were dropped for the
				`x86-unknown_linux-gnu` target. Angle now requires that the host system has `libc` >= 2.18 and
				...
				OSes](http://github.com/khulnasoft/angle/issues/13183) in the future.
				"""
			pr_numbers: []
		},
	]
	...
	commits: [
		{sha: "274df231ea01438cfa28088daa78596b4825a9c2", date: "2022-05-19 12:08:20 UTC", description: "abort reflectors on angle reload", pr_number:                                                               12766, scopes: ["kubernetes_logs"], type:                              "fix", breaking_change:         false, author: "Maksim Nabokikh", files_count:       1, insertions_count:   16, deletions_count:   2},
		...
		{sha: "acc246ddcecb8f27fc4435264208316cb60957d4", date: "2022-06-01 08:43:12 UTC", description: "fix the `BytesReceived` event for v2 variant", pr_number:                                                    12910, scopes: ["angle source"], type:                                "chore", breaking_change:       false, author: "Toby Lawrence", files_count:         5, insertions_count:   397, deletions_count:  48},
		...
		{sha: "13ecdbd806809a78170e1c6408caa03036566e1e", date: "2022-06-02 00:57:16 UTC", description: "Fix overriding Angle fields in enterprise logs", pr_number:                                                 12929, scopes: ["observability"], type:                                "fix", breaking_change:         false, author: "Will", files_count:                  1, insertions_count:   6, deletions_count:    8},
		...
		{sha: "a26f14fb687f202b0ca13e2fd00f0f4fcae08888", date: "2022-06-08 07:33:20 UTC", description: "Add script to run angle with minimal features", pr_number:                                                  13000, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:         2, insertions_count:   72, deletions_count:   0},
		...
		{sha: "bcb29183191e2597165f8015e3b02f26c3084933", date: "2022-06-09 02:21:33 UTC", description: "Move finalizers and shutdown into `angle-core`", pr_number:                                                 13035, scopes: [], type:                                               "chore", breaking_change:       false, author: "Bruce Guenter", files_count:         19, insertions_count:  84, deletions_count:   97},
		...
		{sha: "e2609bf5f3febcd8b0c7a9a0fb22cd570db5fcb8", date: "2022-06-14 06:57:47 UTC", description: "Move `shutdown` and event finalization to `angle-common`", pr_number:                                       13123, scopes: [], type:                                               "chore", breaking_change:       false, author: "Bruce Guenter", files_count:         26, insertions_count:  119, deletions_count:  63},
		...
		{sha: "4ef72fabcb43a9127a033afc1ae6abbd8aa54a3c", date: "2022-06-15 04:19:17 UTC", description: "Fix `serde` feature flag in `angle-common`", pr_number:                                                     13149, scopes: ["core"], type:                                         "chore", breaking_change:       false, author: "Bruce Guenter", files_count:         2, insertions_count:   40, deletions_count:   34},
		...
		{sha: "25676e6c7b0af51ff29b61ed116fb29db9e2d9e7", date: "2022-06-27 23:11:38 UTC", description: "Re-add `angle vrl`", pr_number:                                                                             13347, scopes: ["cli"], type:                                          "fix", breaking_change:         false, author: "Jesse Szwedko", files_count:         1, insertions_count:   13, deletions_count:   13},

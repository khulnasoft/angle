...
releases: "0.16.1": {
	...
	description: """
		The Angle team is pleased to announce version 0.16.1!

		This release contains two bug fixes from the 0.16.0 release:

		* Fixing an issue where Angle would crash when loading disk buffers
		* Fixing an issue where the `angle` sink would incorrectly try to use `http://` when `tls` was enabled
	...
	commits: [
		...
		{sha: "8dc98d16d456e594449525f71ea73d9ca000cfe3", date: "2021-08-27 06:50:06 UTC", description: "set correct default scheme for TLS connections", pr_number:     8901, scopes: ["angle sink"], type: "fix", breaking_change:   false, author: "Jean Mertz", files_count:    1, insertions_count: 32, deletions_count:  10},
	]
}

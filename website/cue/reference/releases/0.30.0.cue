...
releases: "0.30.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.30.0!
	...
	changelog: [
		...
		},
		{
			...
			description: """
				...
				requests from Angle hit the Kubernetes API server cache rather than always hitting
		...
		},
		{
			...
			scopes: ["releasing"]
			description: """
				Angle's distroless libc docker images (tags ending in `-distroless-libc`) are now
				based on Debian 11 rather than Debian 10. This matches Angle's published Debian
		...
		},
		{
			...
			description: """
				Angle's internal logs were updated to use "suppress" rather than "rate-limit" in
				the hopes that it makes it clearer that it is only Angle's log output that is being
	...
	commits: [
		...
		{sha: "3834612cb052edcae99f22aecbf07fdad32f816c", date: "2023-04-13 06:35:34 UTC", description: "Bump Angle version to 0.30.0", pr_number:                                                                                 17134, scopes: ["releasing"], type:                    "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:        2, insertions_count:   2, deletions_count:    2},

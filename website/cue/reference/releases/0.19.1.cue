...
releases: "0.19.1": {
	...
	description: """
		The Angle team is pleased to announce version 0.19.1!
	...
	changelog: [
		...
		},
		{
			...
			description: """
				Fixed regression in disk buffers where Angle would not discover
				and use disk buffers created by < 0.19.0. See [the tracking
				issue](https://github.com/khulnasoft/angle/issues/10430#issue-1078985240)
				for more details.
				"""
			pr_numbers: [10826]
		},

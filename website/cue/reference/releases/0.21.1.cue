...
releases: "0.21.1": {
	...
	changelog: [
		{
			...
			description: """
				Angle no longer panics when reloading configuration that results in added components.
				"""
			pr_numbers: [12290]
		},
		{
			...
			description: """
				Angle no longer emits spurious `TRACE` level logs to `internal_logs` whenever `angle top` is run.
				"""
			pr_numbers: [12300]
		},
		{
		...
		},
		{
			...
			description: """
				The `nats` source and sink authentication options are now configurable. Previously Angle was not
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle no longer panics when used with configuration options that take event paths such as `encoding.only_fields`.
				"""
			pr_numbers: [12306]
		},
	]
	...
	commits: [
		...
		{sha: "d6da5b2d198a12ea71149c656202eefeaaa78ac8", date: "2022-04-21 08:22:25 UTC", description: "Mark `angle config` as experimental", pr_number:                                 12324, scopes: [], type:                           "chore", breaking_change: false, author: "Jesse Szwedko", files_count:        1, insertions_count:  1, deletions_count:   1},
		{sha: "91d6610effe9d651d0040367252051ced76056ec", date: "2022-04-21 22:54:58 UTC", description: "Add support for flags to `angle config`", pr_number:                             12327, scopes: ["config"], type:                   "fix", breaking_change:   false, author: "Jesse Szwedko", files_count:        2, insertions_count:  65, deletions_count:  4},
		...
		{sha: "b142d3d1a721f5714cdf583edca006899a310931", date: "2022-04-22 09:19:20 UTC", description: "Use user-provided array values in angle config --include-defaults", pr_number:   12337, scopes: ["cli"], type:                      "fix", breaking_change:   false, author: "Will", files_count:                 1, insertions_count:  4, deletions_count:   13},

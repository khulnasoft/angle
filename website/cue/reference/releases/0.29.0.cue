...
releases: "0.29.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.29.0!
		...
		the [OpenDAL library](https://github.com/apache/incubator-opendal) into Angle, starting
		with the `webhdfs` sink, to prove out the ability to use it to more easily support
		additional Angle sinks in the future.

		Additionally, for Angle developers, two new tutorials were added for developing Angle
		sinks: [docs](https://github.com/khulnasoft/angle/tree/master/docs/tutorials/sinks). We
		hope this makes it easier to add Angle sinks in the future.
		"""
	...
	changelog: [
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle components can now bind to the same port on different IP addresses including
				different IP address families. Previously Angle would report that the addresses
				conflicted.
				"""
		...
		},
		{
			...
			description: """
				...
				expected user behavior when Angle exits.
				"""
		...
		},
		{
			...
			description: """
				Angle now logs signals that it receives, and handles, at the INFO level. Unhandled
				signals are ignored.
				"""
			contributors: ["zamazan4ik"]
			pr_numbers: [16835]
		...
		},
		{
			...
			scopes: ["core"]
			description: """
				Comparisons of float fields in Angle was fixed to completely compare the value.
		...
		},
		{
			...
			scopes: ["file source"]
			description: """
				The `file` source now handles acknowledgements when Angle is shutting down and
				sinks are flushing events. Previously the `file` source would ignore all
				acknowledgements once Angle starts to shut down.
				"""
			contributors: ["jches"]
			pr_numbers: [16928]
		},
	...
	commits: [
		...
		{sha: "55bc9e8913470ddd751274816b7af12a014ef09d", date: "2023-02-25 05:10:36 UTC", description: "extend SUPPORT.md to include guidelines on how to ask a support question about Angle", pr_number: 16501, scopes: ["docs"], type:                        "chore", breaking_change:       false, author: "neuronull", files_count:          1, insertions_count:   101, deletions_count:  2},
		...
		{sha: "81c36b8ffe160f2fc292d92dfd066f57c206f94e", date: "2023-03-01 05:15:21 UTC", description: "Bump Angle version to 0.29.0", pr_number:                                                         16611, scopes: ["releasing"], type:                   "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:      2, insertions_count:   2, deletions_count:    2},
		...
		{sha: "25b64cfab1623cdaa3434b79dd185306d82ad1fd", date: "2023-03-10 09:02:18 UTC", description: "Only validate definitions with Angle LogNamespace", pr_number:                                    16739, scopes: ["schemas"], type:                     "enhancement", breaking_change: false, author: "Stephen Wakely", files_count:     2, insertions_count:   52, deletions_count:   34},
		...
		{sha: "23770c8a65c7f2ae612f793b6ec0fe4a81a20b2f", date: "2023-03-11 08:42:06 UTC", description: "Upgrade Angle to Rust 1.68 (clippy fixes only)", pr_number:                                       16745, scopes: ["core"], type:                        "chore", breaking_change:       false, author: "Nathan Fox", files_count:         66, insertions_count:  156, deletions_count:  338},
		...
		{sha: "b5323870fe14d135667cab4253206da4ee84cd19", date: "2023-03-21 22:39:00 UTC", description: "Move the `build` subcommand to `build angle`", pr_number:                                         16877, scopes: ["vdev"], type:                        "chore", breaking_change:       false, author: "Bruce Guenter", files_count:      2, insertions_count:   5, deletions_count:    1},
		...
		{sha: "532e9da0a449cd2a3352179938f22557c4e21933", date: "2023-03-23 02:04:10 UTC", description: "VRL separation part 3 (angle-common)", pr_number:                                                 16684, scopes: ["vrl"], type:                         "chore", breaking_change:       false, author: "Nathan Fox", files_count:         74, insertions_count:  334, deletions_count:  309},
		...
		{sha: "22bdc78c62f4db2086463680de4796186364c2a1", date: "2023-03-24 23:45:39 UTC", description: "Log tui errors encountered during `angle top`", pr_number:                                        16857, scopes: ["cli"], type:                         "enhancement", breaking_change: false, author: "Jesse Szwedko", files_count:      1, insertions_count:   2, deletions_count:    2},
		...
		{sha: "fc028c9b7150d5bcade47c77e739d765f1d7f4b7", date: "2023-04-05 05:25:22 UTC", description: "Add Angle VRL web playground", pr_number:                                                         17042, scopes: [], type:                              "chore", breaking_change:       false, author: "Nathan Fox", files_count:         33, insertions_count:  1805, deletions_count: 139},

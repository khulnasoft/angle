	...
	changelog: [
		{
			...
			scopes: ["config"]
			description: """
				Angle now loads configurations using environment variables outside of string values
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle now loads multi-file configurations using the global `timezone` configuration
				option again.
				"""
			pr_numbers: [15077]
		},

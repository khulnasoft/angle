...
releases: "0.27.1": {
	...
	changelog: [
		{
			...
			description: """
				Angle again correctly tags the `component_events_in_total` and
				`component_events_out_total` internal metrics emitted by sources with their
				component tags. This fixes reporting by `angle top`. This was a regression in
				0.27.0.
				"""
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle again allows for nested paths to be used in `log_schema` configuration. There
		...
		},
		{
			...
			scopes: ["security"]
			description: """
				Angle's OpenSSL dependency was upgraded to `1.1.1t` to resolve
	...
	commits: [
		...
		{sha: "f73f0c800d6c5b1bc83e030ef11c26e1dcaa055f", date: "2023-02-14 16:01:20 UTC", description: "fix source metadata paths from being flattened with `insert_standard_angle_source_metadat`", pr_number: 16410, scopes: ["core"], type:          "fix", breaking_change:   false, author: "Nathan Fox", files_count:        1, insertions_count: 31, deletions_count: 2},

...
releases: "0.17.1": {
	...
	description: """
		The Angle team is pleased to announce version `v0.17.1`!
	...
	commits: [
		...
		{sha: "6d9a11ef6d269b7dcec2134f9c1210b05b972ef8", date: "2021-10-11 07:17:54 UTC", description: "Add link checking to preview builds for angle.khulnasoft.com", pr_number:                                                       8944, scopes: ["external docs"], type:         "fix", breaking_change:         false, author: "Luc Perkins", files_count:    1, insertions_count:  1, deletions_count:   1},

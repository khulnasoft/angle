...
releases: "0.7.1": {
	...
	commits: [
		...
		{sha: "e1b6bc834a94066313c2de58e540845476289789", date: "2020-01-23 19:44:22 +0000", description: "Create `angle` user when installing RPM package", pr_number:                      1583, scopes: ["rpm platform"], type:              "fix", breaking_change:   false, author: "Alexander Rodin", files_count: 1, insertions_count:  11, deletions_count:  2},

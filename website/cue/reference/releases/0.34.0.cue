...
releases: "0.34.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.34.0!
		...
		`repositories.timber.io`. Instead, packages have been moved to `apt.angle.khulnasoft.com` and
		`yum.angle.khulnasoft.com`. Please see the [release
	...
	known_issues: [
		"""
			...
			sized batches [#19110](https://github.com/khulnasoft/angle/issues/19110). This will
	...
	changelog: [
		...
		},
		{
			...
			description: """
				...
				with the `http` sink to send data between Angle instances using the `native` or
				`native_json` codecs; however, the `angle` source/sink pair is still the preferred route for
				Angle-to-Angle communication.
				"""
			pr_numbers: [18781]
		},
		{
			...
			description: """
				...
				rebalancing and when Angle is shutting down. This avoids situations where Angle
		...
		},
		{
			...
			scopes: ["releasing"]
			description: """
				The armv7 rpm package, `angle-<version>-1.armv7.rpm`, is no longer published. It
				has been replaced by `angle-<version>-1.armv7hl.rpm` to better follow RPM
		...
		},
		{
			...
			description: """
				...
				Angle now emits an error event when this occurs.
				"""
		...
		},
		{
			...
			description: """
				...
				As part of this change, disk buffers created by Angle now have more restrictive
				file permissions on Unix platforms. Previously, they were world-readable, but are now
				only writable by the Angle process user (typically `angle`) and readable by group.
		...
		},
		{
			...
			scopes: ["vrl"]
			description: """
				Angle's version of VRL was updated to 0.8.1, with the following changes:
		...
		},
		{
			...
			scopes: ["cli"]
			description: """
				Angle now has the ability to start with an empty configuration when using
				`--allow-empty-config`. This is useful if you want to start Angle before loading
	...
	commits: [
		...
		{sha: "e2b7de07795b1a649ceb6d0e9555034a042d490b", date: "2023-09-27 07:51:01 UTC", description: "Add Angle workload checks", pr_number:                                                             18569, scopes: ["ci"], type:                                           "feat", breaking_change:        false, author: "Pavlos Rontidis", files_count:  8, insertions_count:    277, deletions_count:  1},
		...
		{sha: "1c2f9704e4c4c799e75500b9250a976890e79329", date: "2023-09-28 00:15:16 UTC", description: "Bump Angle version to v0.34.0", pr_number:                                                         18693, scopes: ["releasing"], type:                                    "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:    2, insertions_count:    2, deletions_count:    2},
		...
		{sha: "efb0d1a59074ea6e097918a230d552204161c42a", date: "2023-10-14 02:55:00 UTC", description: "remove config/angle.toml", pr_number:                                                              18833, scopes: [], type:                                               "chore", breaking_change:       false, author: "Pavlos Rontidis", files_count:  1, insertions_count:    0, deletions_count:    44},
		...
		{sha: "ab8f8d28e2535340dcd6b146bc6072e6ae124fd7", date: "2023-10-20 04:00:03 UTC", description: "Update *-release.md issue templates for angle.khulnasoft.com package release", pr_number:                     18814, scopes: [], type:                                               "chore", breaking_change:       false, author: "Spencer Gilbert", files_count:  2, insertions_count:    2, deletions_count:    0},
		...
		{sha: "96f4d73d3a8614d721bdb27845b7721e8d266bb8", date: "2023-10-24 04:28:24 UTC", description: "Refactor `angle-core::stream` into its own package", pr_number:                                    18900, scopes: ["core"], type:                                         "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    47, insertions_count:   166, deletions_count:  140},
		...
		{sha: "00c40d7cbe90287a0ee22ed2707576948a89cfff", date: "2023-10-25 23:29:05 UTC", description: "Set up `angle-lib` wrapper crate with `angle-common`", pr_number:                                 18927, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    260, insertions_count:  488, deletions_count:  552},
		...
		{sha: "270fdfd6002f58275610995e232aae241ada4822", date: "2023-10-26 03:16:52 UTC", description: "Wrap `angle-core` in `angle-lib`", pr_number:                                                     18934, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    401, insertions_count:  677, deletions_count:  658},
		...
		{sha: "42beb3f099f34c20b890b2d5f9f9ee07dc5697de", date: "2023-10-27 05:02:11 UTC", description: "Wrap `angle-config` in `angle-lib` as `configurable`", pr_number:                                 18944, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    215, insertions_count:  359, deletions_count:  300},
		...
		{sha: "8a02b168d4904d0837028b1ef9fc9743d9dee345", date: "2023-10-27 11:10:19 UTC", description: "Wrap `angle-stream` in `angle-lib`", pr_number:                                                   18953, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    35, insertions_count:   37, deletions_count:   36},
		...
		{sha: "5f30f74bbb15edeea13051703ddd16945479c6c8", date: "2023-10-28 02:10:23 UTC", description: "Add wrapper for `codecs` to `angle-lib`", pr_number:                                               18959, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    119, insertions_count:  242, deletions_count:  214},
		...
		{sha: "2cef62c0ab8f1bfa39c12687cb6b8b36b20ef856", date: "2023-10-28 07:22:33 UTC", description: "Add wrapper for `angle-buffers` to `angle-lib`", pr_number:                                       18964, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    20, insertions_count:   20, deletions_count:   21},
		...
		{sha: "e61f308aab380b1af9c6b1e99a57d66181270ee8", date: "2023-10-31 02:35:34 UTC", description: "Add wrapper for `enrichment` to `angle-lib`", pr_number:                                           18977, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    31, insertions_count:   83, deletions_count:   64},
		...
		{sha: "f44da167b24d926d47168167e599b79515919a44", date: "2023-10-31 10:03:10 UTC", description: "Add wrapper for `file-source` in `angle-lib`", pr_number:                                          18984, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    9, insertions_count:    23, deletions_count:   20},
		...
		{sha: "1eb418bedd34a2ac8efe9f2980e2263e42e84abe", date: "2023-10-31 22:42:33 UTC", description: "Add `angle-lib` wrapper for three more libs", pr_number:                                           18992, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    17, insertions_count:   53, deletions_count:   38},
		{sha: "164f1e9b716743569c3ede5ec5936a28a6882142", date: "2023-11-01 01:04:25 UTC", description: "Add wrapper for `lookup` in `angle-lib`", pr_number:                                               18995, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    103, insertions_count:  188, deletions_count:  273},
		{sha: "9893b8697e2e3ab30edf85d90fbb0b45244c8f6e", date: "2023-11-01 03:04:29 UTC", description: "Follow redirects for `sh.angle.khulnasoft.com`", pr_number:                                                   19000, scopes: [], type:                                               "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:    7, insertions_count:    8, deletions_count:    8},
		...
		{sha: "4f613ce3c1c498fd61c8c60cb282a81e83174521", date: "2023-11-07 01:18:57 UTC", description: "Move some macros into `angle-core`", pr_number:                                                    19002, scopes: ["dev"], type:                                          "chore", breaking_change:       false, author: "Bruce Guenter", files_count:    62, insertions_count:   88, deletions_count:   146},

...
releases: "0.20.0": {
	...
	known_issues: [
		"When unit testing targets that have multiple outputs, Angle logs a warning for untested outputs. Will be fixed in `0.20.1`.",
		"If nonexistent extract_from/no_outputs_from targets are included in unit testing configurations, `angle test` will panic. Will be fixed in `0.20.1`.",
	]

	description: """
		The Angle team is pleased to announce version 0.20.0!
	...
	changelog: [
		{
			...
			description: """
				...
				article](/highlights/2022-01-12-angle-unit-test-improvements) for more details.
				"""
			pr_numbers: [10540]
		},
		{
			...
			description: """
				The `route` transform was refactored to rely on Angle's new concept of named outputs for components.
		...
		},
		{
			...
			description: """
				The telemetry for a few components was updated as a result expanding the use of named outputs in Angle for components with multiple output streams:
		...
		},
		{
			...
			description: """
				...
				The `foo is 5!` message will appear in Angle's internal logs as well as being used as
		...
		{
			type: "enhancement"
			scopes: ["angle source", "angle sink"]
			description: """
				The `angle` source and `angle` sink now default to version 2 of the protocol for inter-Angle
		...
		},
		{
			...
			description: """
				`angle top` has been updated to show the event metrics per output when a component has multiple outputs.
				"""
			pr_numbers: [11085]
		},
		{
		...
		},
		{
			...
			scopes: ["observability"]
			description: """
				The `angle tap` command has had two enhancements:
	...
	commits: [
		...
		{sha: "f238b79467207df746c61ea2b34d502969061696", date: "2022-01-12 03:56:14 UTC", description: "Address sources of non-angle variability", pr_number:                                                                          10730, scopes: [], type:                               "chore", breaking_change:       false, author: "Brian L. Troutwine", files_count: 56, insertions_count:  508, deletions_count:  377},
		...
		{sha: "85edc36d518308a04711632bc785f789f6855344", date: "2022-01-19 07:10:03 UTC", description: "Add highlight article for Angle unit testing updates", pr_number:                                                              10827, scopes: ["highlights website"], type:           "docs", breaking_change:        false, author: "Will", files_count:               1, insertions_count:   48, deletions_count:   0},
		...
		{sha: "dc1ad916ca351792646100fed99201137f68d2e7", date: "2022-01-19 12:25:55 UTC", description: "Move the conversion to EventArray out of AngleSink", pr_number:                                                                10889, scopes: ["core"], type:                         "chore", breaking_change:       false, author: "Bruce Guenter", files_count:      41, insertions_count:  288, deletions_count:  170},
		...
		{sha: "439b2677cfbdf462f12731c3de31111adb7ecbba", date: "2022-01-22 09:51:13 UTC", description: "Add unit tests for angle tap on multiple outputs", pr_number:                                                                  10972, scopes: ["api"], type:                          "chore", breaking_change:       false, author: "Will", files_count:               1, insertions_count:   128, deletions_count:  0},
		...
		{sha: "b69cadc8cc445fcb50dfa843861b0f67fa992f5f", date: "2022-01-25 11:36:16 UTC", description: "Fix flakey angle tap test", pr_number:                                                                                         11008, scopes: ["api"], type:                          "chore", breaking_change:       false, author: "Will", files_count:               1, insertions_count:   2, deletions_count:    2},
		...
		{sha: "4ebe2c47f2cffd690438e12c349b7e6f5a0705c2", date: "2022-01-26 04:16:58 UTC", description: "Default to version 2", pr_number:                                                                                               11023, scopes: ["angle source", "angle sink"], type: "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:      3, insertions_count:   22, deletions_count:   3},
		...
		{sha: "35d2a7e06d5b8ad8b59cba1cee7e1c95919f0138", date: "2022-01-27 00:51:59 UTC", description: "Document unsupported version 2 options", pr_number:                                                                             11040, scopes: ["angle source", "angle sink"], type: "docs", breaking_change:        false, author: "Jesse Szwedko", files_count:      2, insertions_count:   19, deletions_count:   0},
		...
		{sha: "2c06286cc74fd2df6f78552a05a1dbb5d12a399d", date: "2022-01-28 12:32:56 UTC", description: "skaffold: Update `.metadata.name` to fix local angle binary build", pr_number:                                                 11004, scopes: ["dev"], type:                          "fix", breaking_change:         false, author: "Pranjal Gupta", files_count:      1, insertions_count:   1, deletions_count:    1},
		...
		{sha: "a398504fe21ff64a065f97b203539ce986e4e889", date: "2022-02-01 08:04:17 UTC", description: "Merge shared and angle-common crates", pr_number:                                                                              11087, scopes: ["core"], type:                         "chore", breaking_change:       false, author: "Bruce Guenter", files_count:      127, insertions_count: 363, deletions_count:  674},
		...
		{sha: "078c316c7b5149f45178514f1c2836a69a7cbd52", date: "2022-02-02 06:46:12 UTC", description: "Display component output streams in angle top", pr_number:                                                                     11085, scopes: ["observability"], type:                "enhancement", breaking_change: false, author: "Will", files_count:               8, insertions_count:   232, deletions_count:  67},
		...
		{sha: "d0f782de957377c6555f2225f45ca4d594ecfcd1", date: "2022-02-04 13:48:44 UTC", description: "comply with component spec", pr_number:                                                                                         11059, scopes: ["angle source"], type:                "enhancement", breaking_change: false, author: "Jérémie Drouet", files_count:     4, insertions_count:   42, deletions_count:   11},
		...
		{sha: "eb8df46cb51b8f4ff231730af034bae0e1cca2a9", date: "2022-02-05 02:10:19 UTC", description: "Fix flakey angle tap integration test", pr_number:                                                                             11186, scopes: ["api"], type:                          "chore", breaking_change:       false, author: "Will", files_count:               1, insertions_count:   30, deletions_count:   11},
		...
		{sha: "468d525756b9e7801ccdb288638bf2a70228c021", date: "2022-02-09 11:35:19 UTC", description: "Support metric events in angle tap", pr_number:                                                                                11201, scopes: ["api"], type:                          "enhancement", breaking_change: false, author: "Will", files_count:               10, insertions_count:  461, deletions_count:  33},
		...
		{sha: "691c8534f91af0f0379868a5d927c67803a50396", date: "2022-02-10 03:28:38 UTC", description: "Support logfmt formatting option in angle tap", pr_number:                                                                     11234, scopes: ["api"], type:                          "enhancement", breaking_change: false, author: "Will", files_count:               6, insertions_count:   29, deletions_count:   1},

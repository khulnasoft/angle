...
releases: "0.33.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.33.0!

		Be sure to check out the [upgrade guide](/highlights/2023-09-27-0-33-0-upgrade-guide) for
		breaking changes in this release.

		This release marks the switch of the default configuration language for Angle from TOML to
		...
		well as more consistency with Angle's Helm chart which requires YAML configuration. See the
	...
	known_issues: [
		"The Debian package installer will overwrite existing `/etc/default/angle` and `/etc/angle/angle.yaml` files. This was fixed in v0.33.1.",
	...
	changelog: [
		{
			...
			description: """
				...
				- `clear_environment` to remove environment variables propagated from Angle process
		...
		},
		{
			...
			scopes: ["cli"]
			description: """
				Angle now has the ability to disable OpenSSL probing for remote certificates via
				`--openssl-no-probe` (or `ANGLE_OPENSSL_NO_PROBE`).
				"""
			contributors: ["hhromic"]
			pr_numbers: [18229]
		},
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle now parses more configuration fields that represent "event paths" (like the
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				The default configuration language for Angle was updated from TOML to YAML. See the
				[highlight](/highlights/2023-08-30-yaml-default-format) for more details on the
				motivation for this change.

				As part of this migration, Angle will prefer the `/etc/angle/angle.yaml` as the
				default location in the future rather than `/etc/angle/angle.toml`.
				"""
		...
		},
		{
			...
			description: """
				...
				**Note** this does not yet work when accessing the STS endpoints to fetch
				...
				[#18382](https://github.com/khulnasoft/angle/issues/18382).
				"""
			pr_numbers: [18390]
		},
		{
		...
		},
		{
			...
			scopes: ["metrics"]
			description: """
				Angle avoids a panic that occurred when attempting to encode an empty sketch metric.
				"""
			pr_numbers: [18530]
		},
		{
		...
		},
		{
			...
			scopes: ["performance"]
			description: """
				Angle now defaults the worker thread concurrency to the detection provided by the
		...
		},
		{
			...
			scopes: ["platform"]
			description: """
				The published Angle artifacts are now compiled with an allocator page size of 64 kb
				rather than 4 kb. This allows Angle to run on systems with 64 kb pages (e.g. CentOS
		...
		},
		{
			...
			scopes: ["codec"]
			description: """
				Angle's protobuf definition for events was updated to have a new field to store
				metadata. Most users will not care about this, but if you are consuming Angle's
				protobuf encoded events directly please see [upgrade
				guide](/highlights/2023-09-27-0-33-0-upgrade-guide#angle-proto-metadata).
				"""
			pr_numbers: [18405]
		},
		{
	...
	commits: [
		...
		{sha: "ef51e7a52e0fadea78b0f68c78d4bee78d1fb6bc", date: "2023-08-16 00:05:14 UTC", description: "Bump Angle to 0.33.0", pr_number:                                                              18250, scopes: ["releasing"], type:                                                  "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:    2, insertions_count:    2, deletions_count:    2},
		...
		{sha: "f15144bb16a5d7a7389b20e2625c162101907f02", date: "2023-08-25 05:50:07 UTC", description: "Fix deserializing non-object values with the `Angle` namespace", pr_number:                    18379, scopes: ["json codec"], type:                                                 "fix", breaking_change:         false, author: "Nathan Fox", files_count:       5, insertions_count:    95, deletions_count:   48},
		...
		{sha: "9d295634538b9e97c0dbee1e1c72672c090ff83f", date: "2023-09-19 05:57:08 UTC", description: "Replace 'angle.toml' with 'angle.yaml'", pr_number:                                           18388, scopes: ["config", "docs"], type:                                             "chore", breaking_change:       false, author: "Pavlos Rontidis", files_count:  26, insertions_count:   143, deletions_count:  46},
		...
		{sha: "76efb4b91792a8c59eb7c4b0376220364dd2d72f", date: "2023-09-22 01:30:58 UTC", description: "Update chat.angle.khulnasoft.com redirect", pr_number:                                                    18635, scopes: ["website"], type:                                                    "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:    1, insertions_count:    1, deletions_count:    1},

...
releases: "0.20.1": {
	...
	description: """
		The Angle team is pleased to announce version 0.20.1!
	...
	changelog: [
		...
		},
		{
			...
			description: """
				Previously idle connections would cause the `socket` source to cease processing due to Angle's rate
	...
	commits: [
		...
		{sha: "819789d0be1fc538ab91953c02c1632a6e8a68fc", date: "2022-02-16 07:38:23 UTC", description: "Update angle source/sink highlight timeline", pr_number:               11400, scopes: [], type:                   "docs", breaking_change:  false, author: "Jesse Szwedko", files_count:        1, insertions_count:  4, deletions_count:    5},

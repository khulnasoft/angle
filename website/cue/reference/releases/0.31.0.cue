...
releases: "0.31.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.31.0!
		...
		accessible via `%<datadog_agent>.<field>`, and Angle added metadata:
		...
		post](/blog/log-namespacing) for an expanded explanation and details. Let us know what you think [on this issue](https://github.com/khulnasoft/angle/issues/17796).
		"""
	...
	changelog: [
		...
		},
		{
			...
			scopes: ["shutdown"]
			description: """
				Angle's graceful shutdown time limit is now configurable (via
		...
		},
		{
			...
			scopes: ["shutdown"]
			description: """
				Angle now exits non-zero if the graceful shutdown time limit expires before Angle
		...
		},
		{
			...
			description: """
				...
				capture as much telemetry as possible during Angle shutdown.
				"""
			pr_numbers: [17741]
		},
		{
		...
		},
		{
			...
			scopes: ["file source"]
			description: """
				Angle now supports running greater than 512 sources. Previously it would lock up if
	...
	commits: [
		...
		{sha: "54d9c99492ec14924994a4857961aaafe3200f9b", date: "2023-05-20 08:46:28 UTC", description: "Add info about Angle Operator to Kubernetes instalation page", pr_number:                       17432, scopes: ["docs"], type:                           "chore", breaking_change:       false, author: "Vladimir", files_count:          1, insertions_count:   7, deletions_count:    1},
		...
		{sha: "0dc450fac14ac0236ca48466fd4fe42630d421ed", date: "2023-06-09 05:44:35 UTC", description: "mark AngleSink::from_event_sink as deprecated", pr_number:                                      17649, scopes: ["sinks"], type:                          "chore", breaking_change:       false, author: "Doug Smith", files_count:        20, insertions_count:  26, deletions_count:   0},
		{sha: "45a28f88a910c8492872773cc2e86045c8e2f4b6", date: "2023-06-10 05:28:33 UTC", description: "avoid importing angle-common in enrichment module", pr_number:                                  17653, scopes: ["enrichment"], type:                     "chore", breaking_change:       false, author: "Jérémie Drouet", files_count:    4, insertions_count:   7, deletions_count:    6},
		...
		{sha: "6705bdde058b1a532eda9398c9610dff46bb783b", date: "2023-06-21 05:30:41 UTC", description: "Angle does not put the Proxy-Authorization header on the wire (#17353)", pr_number:             17363, scopes: ["auth"], type:                           "fix", breaking_change:         false, author: "Sergey Yedrikov", files_count:   2, insertions_count:   38, deletions_count:   18},

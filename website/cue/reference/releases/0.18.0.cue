...
releases: "0.18.0": {
	...
	description: """
		The Angle team is pleased to announce version 0.18.0!

		Be sure to check out the [upgrade guide](/highlights/2021-11-18-0-18-0-upgrade-guide) for breaking changes in this release.

		In case you missed it, we've also released a new unified `angle` helm chart! This new chart can deployed as either
		as either an agent or aggregator role and so deprecates our existing `angle-agent` and `angle-aggregator` charts.
		See the [chart upgrade
		guide](https://github.com/khulnasoft/helm-charts/blob/develop/charts/angle/README.md#upgrading) for how to
	...
	known_issues: [
		...
		"The new automatic namespacing feature broke running Angle from the published RPM due to it trying to load directories from `/etc/angle` that are not valid. Fixed in v0.18.1.",
		...
		"If `--config-dir` is used, Angle incorrectly tries to load files with unknown extensions. Fixed in v0.19.0.",
		"""
	...
	changelog: [
		...
		},
		{
			...
			description: """
				...
				added via a new Angle concept, enrichment tables. To start, we've added
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Better support for breaking up Angle configuration into multiple files
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				The `$LOG` environment variable for configuring the Angle log level has
				been renamed to `$ANGLE_LOG`. `$LOG` is still also accepted for backwards
				compatibility. This change makes logging configuration more in-line with
				Angle's other environment variable based options, and isolates Angle from
		...
		},
		{
			...
			description: """
				...
				Specification](https://github.com/khulnasoft/angle/blob/master/docs/specs/component.md#instrumentation).
		...
		},
		{
			...
			scopes: ["performance"]
			description: """
				Configuring the number of threads (via `--threads`) for Angle now actually
		...
		},
		{
			...
			description: """
				Angle no longer crashes when configuration was reloaded that include changes
		...
		},
		{
			...
			description: """
				Fix memory leak that occurred when using Angle as a Windows service.
				"""
		},
		{
			type: "fix"
	...
	whats_next: [
		{
			...
			description: """
				We are in the process of ensuring that all Angle components report a consistent set of metrics to make
				it easier to monitor the performance of Angle.  These metrics are outlined in this new [instrumentation
		...
		},
		{
			...
			description: """
				...
				keys and values in those log events. We recently published an [RFC](\(urls.angle_rfc_8381)) for this and
	...
	commits: [
		...
		{sha: "1ada00235d4aedd125f19b70c0e5b52ae1ca2be8", date: "2021-10-15 22:17:50 UTC", description: "Simplify calling size_of over angles", pr_number:                                                                                     9627, scopes: [], type:                                         "chore", breaking_change:       false, author: "Bruce Guenter", files_count:      7, insertions_count:   10, deletions_count:   14},
		...
		{sha: "a558a9814d83a531aa551b314e7b95e964bf64ef", date: "2021-10-21 00:23:37 UTC", description: "Add batch configuration docs", pr_number:                                                                                              9725, scopes: ["angle sink"], type:                            "docs", breaking_change:        false, author: "Jesse Szwedko", files_count:      1, insertions_count:   6, deletions_count:    1},
		...
		{sha: "ff7db0bef783c0ab873246be6e713c6c10e1dbb2", date: "2021-10-25 22:31:53 UTC", description: "Rename LOG env var to ANGLE_LOG", pr_number:                                                                                          9743, scopes: ["cli"], type:                                    "enhancement", breaking_change: false, author: "Jesse Szwedko", files_count:      8, insertions_count:   65, deletions_count:   33},
		...
		{sha: "5022a45ca365938a12439e0aa3b8443448114176", date: "2021-11-02 18:25:42 UTC", description: "Add event processing metric", pr_number:                                                                                               9830, scopes: ["observability", "angle sink"], type:           "enhancement", breaking_change: false, author: "Bruce Guenter", files_count:      4, insertions_count:   94, deletions_count:   27},
		...
		{sha: "cb688946354fd11cd1d5d9d258ab6af951ee0a0c", date: "2021-11-02 21:07:37 UTC", description: "Instrument with event processing metrics", pr_number:                                                                                  9683, scopes: ["observability", "angle source"], type:         "enhancement", breaking_change: false, author: "Bruce Guenter", files_count:      5, insertions_count:   161, deletions_count:  67},
		...
		{sha: "e3af5a2d99f9431fb9ef10cf580c75be1ea4a05e", date: "2021-11-05 21:44:52 UTC", description: "Fix older angle soak builds", pr_number:                                                                                              9936, scopes: [], type:                                         "chore", breaking_change:       false, author: "Brian L. Troutwine", files_count: 1, insertions_count:   6, deletions_count:    1},
		...
		{sha: "c2c05b31add2b33363cde334babe558870cb5f5b", date: "2021-11-13 04:05:06 UTC", description: "Remove unused 'test_name' variable in angle module", pr_number:                                                                       10003, scopes: [], type:                                        "chore", breaking_change:       false, author: "Brian L. Troutwine", files_count: 13, insertions_count:  0, deletions_count:    20},
		...
		{sha: "b53f2bbe602cef541de9d466efba60fd03239940", date: "2021-11-16 19:24:06 UTC", description: "Add Marketo Tracking to Angle.dev", pr_number:                                                                                        9977, scopes: ["javascript website"], type:                     "chore", breaking_change:       false, author: "David Weid II", files_count:      2, insertions_count:   25, deletions_count:   0},
		...
		{sha: "529905972669bf7a878e1e2d2f6e5004e80fdcfe", date: "2021-11-18 02:03:45 UTC", description: "Remove breaking change note for `ANGLE_LOG`", pr_number:                                                                              10091, scopes: ["releasing"], type:                             "chore", breaking_change:       false, author: "Jesse Szwedko", files_count:      1, insertions_count:   1, deletions_count:    9},

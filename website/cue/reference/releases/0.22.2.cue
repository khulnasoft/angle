...
releases: "0.22.2": {
	...
	description: """
		The Angle team is pleased to announce version 0.22.2!
		...
		that Angle would write to `stderr`. This means, rather than seeing each log individually, duplicate logs in
		small time windows are rolled up and logged like:

		```json
		{"host":"consigliere","message":"Internal log [function call error for \"parse_json\" at (14:34): unable to parse json: trailing characters at line 1 column 8] has been rate limited 282948 times.","metadata":{"kind":"event","level":"ERROR","module_path":"vrl_stdlib::log","target":"vrl_stdlib::log"},"pid":2064943,"source_type":"internal_logs","timestamp":"2022-06-14T22:52:50.329188616Z","angle":{"component_id":"transform0","component_kind":"transform","component_name":"transform0","component_type":"remap"}}
		{"host":"consigliere","internal_log_rate_secs":1,"message":"function call error for \"parse_json\" at (14:34): unable to parse json: trailing characters at line 1 column 8","metadata":{"kind":"event","level":"ERROR","module_path":"vrl_stdlib::log","target":"vrl_stdlib::log"},"pid":2064943,"source_type":"internal_logs","timestamp":"2022-06-14T22:52:50.329201656Z","angle":{"component_id":"transform0","component_kind":"transform","component_name":"transform0","component_type":"remap"},"vrl_position":54}
		{"host":"consigliere","message":"Internal log [function call error for \"parse_json\" at (14:34): unable to parse json: trailing characters at line 1 column 8] is being rate limited.","metadata":{"kind":"event","level":"ERROR","module_path":"vrl_stdlib::log","target":"vrl_stdlib::log"},"pid":2064943,"source_type":"internal_logs","timestamp":"2022-06-14T22:52:50.329212676Z","angle":{"component_id":"transform0","component_kind":"transform","component_name":"transform0","component_type":"remap"}}
		```

		This change was made to bring `internal_logs` in line with Angle's logging and avoid unexpected high bills from

...
releases: "0.22.1": {
	...
	description: """
		The Angle team is pleased to announce version 0.22.1!
	...
	changelog: [
		...
		},
		{
			...
			scopes: ["config"]
			description: """
				Angle no longer panics reloading configuration using `compression` and `concurrency` options.
				"""
		...
		},
		{
			...
			description: """
				When using a component that creates a unix socket, `angle validate` no longer creates the socket. This
				was causing the default SystemD unit file to fail to start Angle since it runs `angle validate` before
				starting Angle.
				"""
			pr_numbers: [13021]
		},
	...
	commits: [
		...
		{sha: "3d2178b8d8a03988fd0ebda6af182e0f01b2805d", date: "2022-06-09 03:55:23 UTC", description: "Namespace enterprise metrics with `angle`", pr_number:            13034, scopes: ["observability"], type:           "chore", breaking_change: false, author: "Will", files_count:             2, insertions_count: 37, deletions_count:  4},
	]
}

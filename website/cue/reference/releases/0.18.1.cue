...
releases: "0.18.1": {
	...
	description: """
		The Angle team is pleased to announce version `v0.18.1`!
		...
		**Note:** Please see the release notes for [`v0.18.0`](/releases/0.18.0/) for additional changes if upgrading from
		...
		- The new [automatic namespacing](/highlights/2021-11-18-implicit-namespacing/) feature broke usages of
		  `--config-dir` when directories were present that did not match Angle's config schema. Angle now just
		  ignores these directories and only looks at known namespacing directories like `sources/`.
		  [#10173](https://github.com/khulnasoft/angle/pull/10173)
		  [#10177](https://github.com/khulnasoft/angle/pull/10177).
		- The `elasticsearch` sink no longer logs a debug message for each event.
		  [#10117](https://github.com/khulnasoft/angle/pull/10117).
		- The `remap` transform now only creates the `.dropped` output (as part of the new [failed event routing
		  ...
		  [#10152](https://github.com/khulnasoft/angle/pull/10152)
		- A change to internal telemetry had caused aggregated histograms emitted by
		  ...
		  incorrectly tallied. This was fixed. [#10165](https://github.com/khulnasoft/angle/pull/10165)
		"""
	...
	commits: [
		...
		{sha: "3f985ac47acdd6c2bfe81610aebd0de77e08ded2", date: "2021-11-25 06:45:40 UTC", description: "Make example in guides/level-up/managing-complex-configs work with Angle 0.18", pr_number: 10168, scopes: ["config"], type:                   "docs", breaking_change:  false, author: "Robin Schneider", files_count: 1, insertions_count: 2, deletions_count:   3},

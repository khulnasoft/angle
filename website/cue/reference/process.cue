...
process: {
	...
	exit_codes: {
		description: """
			You can find a full list of exit codes in the [`exitcodes` Rust crate](\(urls.exit_codes)). Angle uses the
	...
	process_signals: {
		description: """
			The Angle is built to handle the inter-process communication [signals](\(urls.signal)) listed in the
			table below.
			"""

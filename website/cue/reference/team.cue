...
team: [#Member, ...#Member] & [
	{
		...
		bio: """
			Ben is an engineering manager at Datadog managing the Angle project (formerly the CTO/Co-Founder at Timber.io).
			"""
	},
	{
		...
		_github: "blt"
		bio: """
			Brian is a staff engineer at Datadog and a member of the Angle team.
			"""
	},
	{
		name:    "Bruce Guenter"
		_github: "bruceg"
		bio: """
			Bruce is a software engineer at Datadog on the Angle project (formerly part of Timber.io).
			"""
	},
	{
		name:     "James Turnbull"
	...
	},
	{
		...
		_github: "ktff"
		bio: """
			Kruno is a contractor for Datadog on the Angle project (formerly contracted with at Timber.io).
			"""
	},
	{
		name:    "Lee Benson"
	...
	},
	{
		...
		bio: """
			Luke is the team lead of the Angle project at Datadog (formerly part of Timber.io).
	...
	},
	{
		...
		_twitter: "zsherman"
		bio: """
			Zach is the product manager of the Angle project at Datadog (formerly the CEO/co-founder of Timber.io).
			"""
	},
]

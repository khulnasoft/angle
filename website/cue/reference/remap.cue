	...
	examples: [
		{
			...
			input: log: message: "<102>1 2020-12-22T15:22:31.111Z angle-user.biz su 2666 ID389 - Something went wrong"
			source: """
		...
		},
		{
			...
			input: metric: {
				...
				tags: {
					...
					email:       "vic@angle.khulnasoft.com"
				}
			}
			source: #"""

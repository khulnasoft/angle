remap: features: native: {
	title:       "Angle & Rust native"
	description: """
		Like Angle, VRL is built with [Rust](\(urls.rust)) and compiles to native Rust code. Therefore, it inherits
		Rust's safety and performance characteristics that make it ideal for observability pipelines. And because both
		VRL and Angle are written in Rust, they are tightly integrated, avoiding communication inefficiencies such as

remap: features: high_quality_error_messages: {
	...
	description: """
		...
		2 │ parse_json!(1)
		  ...
		  │
		  = see function documentation at: https://master.angle.khulnasoft.com/docs/reference/vrl/functions/#parse_json
		  = see language documentation at: https://angle.khulnasoft.com/docs/reference/vrl/
		```
		"""

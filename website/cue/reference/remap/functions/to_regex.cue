...
remap: functions: to_regex: {
	...
	description: """
		...
		"""
	notices: ["Compiling a regular expression is an expensive operation and can limit Angle throughput. Don't use this function unless you are absolutely sure there is no other way!"]

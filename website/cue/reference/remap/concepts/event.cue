remap: concepts: event: {
	title:       "Event"
	description: """
		VRL programs operate on observability [events](\(urls.angle_data_model)). This VRL program,
		...
		transform](\(urls.angle_remap_transform)). For any elements that aren't an object, or if

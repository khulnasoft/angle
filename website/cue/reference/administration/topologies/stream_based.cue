...
administration: topologies: stream_based: {
	...
	pros: [
		...
		},
		{
			...
			description: """
				Angle agents are doing less, making them more efficient, and Angle services do not have to worry about
		...
		},
		{
			...
			description: """
				Angle is used solely as a routing layer and is not responsible for durability. Durability is delegated

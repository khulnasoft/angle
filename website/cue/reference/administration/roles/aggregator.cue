...
administration: roles: aggregator: {
	...
	description: """
		...
		For Angle, this role should be reserved for exactly that: cross-host aggregation
		and analysis. Angle is unique in the fact that it can serve both as an Agent

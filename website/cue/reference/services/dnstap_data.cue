	...
	setup: [
		{
			...
			notes: [
				"""
					...
					unix domain socket to be created by Angle (described below).
					""",
			]
		},
		{
			title: "Configure Angle dnstap source component to receive dnstap data output"
			description: """
				Configure Angle dnstap source component to create a server unix
			...
			angle: configure: sources: dnstap: {
				type:             "dnstap"

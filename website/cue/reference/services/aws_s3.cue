			...
			setup: [
				{
					...
					description: """
						Create an AWS SQS queue for Angle to consume bucket notifications from.
						"""
				...
				},
				{
					...
					description: """
						...
						These represent object creation events and ensure Angle does not double process
						S3 objects.
						"""
				...
				},
				{
					...
					description: """
						Using the SQS queue URL provided to you by AWS, configure the Angle `aws_s3`
						source to use the SQS queue via the `sqs.queue_url` option.
						"""
					angle: configure: sources: aws_s3: {
						type: "aws_s3"

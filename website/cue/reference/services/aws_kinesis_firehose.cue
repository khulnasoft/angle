...
services: aws_kinesis_firehose: {
	...
	connect_to: {
		angle: logs: {
			...
			setup: [
				{
					title: "Configure Angle to accept AWS Kinesis Firehose data"
					angle: configure: sources: aws_kinesis_firehose: {
				...
				},
				{
					...
					description: """
						...
						balancer in front of the Angle instance to handle TLS termination
						or configure the `tls` options of the Angle `aws_kinesis_firehose`

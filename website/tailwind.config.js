...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        'inherit': 'inherit',
        'dark': '#191927',  // Angle dark
        'primary': '#28d9f2', // Angle greenish blue
        'primary-dark': '#00a9bc', // Angle darker greenish blue
        'secondary': '#f44af5', // Angle magenta
        'purple-v': '#98f', // Angle purple
        // Brand colors
        'twitter-blue': '#1DA1F2',

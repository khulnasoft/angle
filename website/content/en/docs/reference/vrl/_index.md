---
title: Angle Remap Language (VRL)
description: A domain-specific language for modifying your observability data
short: Angle Remap Language
weight: 1
aliases: ["/docs/reference/remap"]
---

Angle Remap Language (VRL) is an expression-oriented language designed for
...
You can use VRL in Angle via the [`remap`][remap] transform. For a more
...
Those programs are specified as part of your Angle [configuration]. Here's an
...
this [issue filter](https://github.com/khulnasoft/angle/issues?q=is%3Aopen+is%3Aissue+label%3A%22vrl%3A+playground%22+wasm+compatible)
{{< /info >}}

## The goals of VRL {#goals}

VRL is built by the Angle team and its development is guided by two core goals,
...
| [Angle and Rust native](#angle-rust-native) | ✅      | ✅           |
...
[blog_post]: /blog/angle-remap-language

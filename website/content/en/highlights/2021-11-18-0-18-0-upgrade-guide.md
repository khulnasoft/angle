...
Angle's 0.18.0 release includes **breaking changes**:
...
`upper_limit` is a holdover from the initial implementation of metrics support in Angle and applies
...
As part of our continued efforts to keep the configuration and documentation for Angle as clean as

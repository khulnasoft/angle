...
Angle's 0.15.0 release includes a few minor breaking changes:
...
This version of Kubernetes is likely to still work with Angle, but we will no longer be testing against it and cannot
guarantee future versions of Angle will be compatible.

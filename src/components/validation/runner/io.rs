...
use tower::Service;
use angle_lib::shutdown::ShutdownSignal;
use angle_lib::{event::Event, tls::MaybeTlsSettings};
...
use crate::{
    ...
    proto::angle::{
        Client as AngleClient, HealthCheckRequest, HealthCheckResponse, PushEventsRequest,
        PushEventsResponse, Server as AngleServer, Service as AngleService, ServingStatus,
    },
...
#[tonic::async_trait]
impl AngleService for EventForwardService {
...
impl InputEdge {
    pub fn from_address(address: GrpcAddress) -> Self {
        ...
        Self {
            client: AngleClient::new(channel),
        }
    }

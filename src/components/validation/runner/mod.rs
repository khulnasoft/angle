...
use angle_lib::codecs::encoding;
use angle_lib::{event::Event, EstimatedJsonEncodedSizeOf};
...
impl Runner {
    ...
    pub async fn run_validation(self) -> Result<Vec<RunnerResults>, angle_lib::Error> {
...
) -> Result<(RunnerInput, RunnerOutput, Option<Encoder<encoding::Framer>>), angle_lib::Error> {

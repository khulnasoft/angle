...
//! The main library to support building Angle.
...
pub mod validate;
#[cfg(windows)]
pub mod angle_windows;

pub use source_sender::SourceSender;
pub use angle_lib::{event, metrics, schema, tcp, tls};
pub use angle_lib::{shutdown, Error, Result};
...
/// The name used to identify this Angle application.
///
/// This can be set at compile-time through the ANGLE_APP_NAME env variable.
/// Defaults to "Angle".
pub fn get_app_name() -> &'static str {
    ...
    option_env!("ANGLE_APP_NAME").unwrap_or(app_name)
}

/// Returns a slugified version of the name used to identify this Angle application.
///
/// Defaults to "angle".
...
/// The current version of Angle in simplified format.
/// `<version-number>-nightly`.
pub fn angle_version() -> impl std::fmt::Display {
    #[cfg(feature = "nightly")]
...
pub fn get_version() -> String {
    let pkg_version = angle_version();
    let build_desc = built_info::ANGLE_BUILD_DESC;
...
/// Returns an estimate of the number of recommended threads that Angle should spawn.

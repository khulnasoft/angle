...
pub(crate) fn create_events_stream(
    ...
    // The resulting angle of `Event` sent to the client. Only one result set will be streamed
    ...
    tokio::spawn(async move {
        ...
        // Collect a angle of results, with a capacity of `limit`. As new `Event`s come in,

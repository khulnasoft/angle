...
async fn full_payload_v1() {
    assert_source_compliance(&HTTP_PUSH_SOURCE_TAGS, async {
...

        {
            ...
            assert_eq!(log["service"], "angle".into());
...
#[test]
fn test_output_schema_definition_json_angle_namespace() {
    ...
    assert_eq!(
        definition,
        Some(
            Definition::new_with_default_metadata(Kind::json(), [LogNamespace::Angle])
                .with_metadata_field(
...
#[test]
fn test_output_schema_definition_bytes_angle_namespace() {
    let definition = toml::from_str::<DatadogAgentConfig>(indoc! { r#"
            address = "0.0.0.0:8012"

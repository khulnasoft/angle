        ...
        unit @ "h" | unit @ "ms" | unit @ "d" => {
            ...
            Metric::new(
                name, MetricKind::Incremental, MetricValue::Distribution {
                    samples: angle_lib::samples![convert_to_base_units(unit, val) => sample_rate as u32],
...
angle_lib::impl_event_data_eq!(ParseError);
...
mod test {
    ...
    use angle_lib::{event::metric::TagValue, metric_tags};
        ...
        assert_event_data_eq!(
            ...
            Ok(Metric::new(
                ...
                MetricValue::Distribution {
                    samples: angle_lib::samples![0.320 => 10],
    ...
    fn sampled_tagged_histogram() {
        assert_event_data_eq!(
            ...
            Ok(Metric::new(
                ...
                MetricKind::Incremental,
                MetricValue::Distribution {
                    samples: angle_lib::samples![320.0 => 10],
                    statistic: StatisticKind::Histogram
                },
            )
            .with_tags(Some(metric_tags!(

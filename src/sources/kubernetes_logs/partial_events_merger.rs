...
mod test {
    ...
    #[tokio::test]
    async fn merge_single_event_angle_namespace() {
        ...
        let input_stream = futures::stream::iter([e_1.into()]);
        let output_stream = merge_partial_events(input_stream, LogNamespace::Angle);
    ...
    #[tokio::test]
    async fn merge_multiple_events_angle_namespace() {
        let mut e_1 = LogEvent::from(value!("test message 1"));
        e_1.insert(

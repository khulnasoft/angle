...
use angle_lib::lookup::{lookup_v2::ValuePath, owned_value_path, path, OwnedTargetPath};
...
mod tests {
    ...
    use angle_lib::lookup::{event_path, lookup_v2::parse_target_path, metadata_path};

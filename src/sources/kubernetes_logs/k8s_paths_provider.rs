...
use angle_lib::file_source::paths_provider::PathsProvider;
...
///
/// See <https://github.com/khulnasoft/angle/issues/6001>
...
const CONTAINER_EXCLUSION_ANNOTATION_KEY: &str = "angle.khulnasoft.com/exclude-containers";

...
mod test {
    ...
    async fn receives_metrics(tls: Option<TlsEnableableConfig>) {
        ...
        angle_lib::assert_event_data_eq!(events, output);
    }
        ...
        vec![
            ...
            Metric::new(
                ...
                MetricValue::AggregatedHistogram {
                    buckets: angle_lib::buckets![ 2.3 => 11, 4.2 => 85 ],
                    count: 96,
                    sum: 156.2,
                },
            )
            ...
            Metric::new(
                ...
                MetricValue::AggregatedSummary {
                    quantiles: angle_lib::quantiles![ 0.1 => 1.2, 0.5 => 3.6, 0.9 => 5.2 ],
                    count: 23,
                    sum: 8.6,
                },
            )
    ...
    async fn receives_metrics_duplicate_labels() {
        ...
        angle_lib::assert_event_data_eq!(expected, output);
    }
}

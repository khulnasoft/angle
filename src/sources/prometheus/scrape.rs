...
use angle_lib::{config::LogNamespace, event::Event};
...
impl HttpClientContext for PrometheusScrapeContext {
    ...
    fn on_response(&mut self, url: &Uri, _header: &Parts, body: &Bytes) -> Option<Vec<Event>> {
        ...
        match parser::parse_text(&body) {
            ...
            Err(error) => {
                if url.path() == "/" {
                    // https://github.com/khulnasoft/angle/pull/3801#issuecomment-700723178
                    warn!(
...
mod test {
    ...
    /// Prometheus itself will reject the metric with an error. Largely to remain backward compatible with older versions of Angle,
    ...
    async fn test_prometheus_duplicate_tags() {
        ...
        let metrics: Vec<angle_lib::event::Metric> = events
            .into_iter()
            .map(|event| event.into_metric())
            .collect();
    ...
    async fn test_prometheus_routing() {
        ...
        config.add_sink(
            ...
            PrometheusExporterConfig {
                ...
                auth: None,
                tls: None,
                default_namespace: Some("angle".into()),
        ...
        assert_eq!(lines, vec![
                "# HELP angle_http_request_duration_seconds http_request_duration_seconds",
                "# TYPE angle_http_request_duration_seconds histogram",
                "angle_http_request_duration_seconds_bucket{le=\"0.05\"} 24054 1612411516789",
                "angle_http_request_duration_seconds_bucket{le=\"0.1\"} 33444 1612411516789",
                "angle_http_request_duration_seconds_bucket{le=\"0.2\"} 100392 1612411516789",
                "angle_http_request_duration_seconds_bucket{le=\"0.5\"} 129389 1612411516789",
                "angle_http_request_duration_seconds_bucket{le=\"1\"} 133988 1612411516789",
                "angle_http_request_duration_seconds_bucket{le=\"+Inf\"} 144320 1612411516789",
                "angle_http_request_duration_seconds_sum 53423 1612411516789",
                "angle_http_request_duration_seconds_count 144320 1612411516789",
                "# HELP angle_prometheus_remote_storage_samples_in_total prometheus_remote_storage_samples_in_total",
                "# TYPE angle_prometheus_remote_storage_samples_in_total gauge",
                "angle_prometheus_remote_storage_samples_in_total 57011636 1612411516789",
                "# HELP angle_promhttp_metric_handler_requests_total promhttp_metric_handler_requests_total",
                "# TYPE angle_promhttp_metric_handler_requests_total counter",
                "angle_promhttp_metric_handler_requests_total{code=\"200\"} 100 1612411516789",
                "angle_promhttp_metric_handler_requests_total{code=\"404\"} 7 1612411516789",
                "# HELP angle_rpc_duration_seconds rpc_duration_seconds",
                "# TYPE angle_rpc_duration_seconds summary",
                "angle_rpc_duration_seconds{code=\"200\",quantile=\"0.01\"} 3102 1612411516789",
                "angle_rpc_duration_seconds{code=\"200\",quantile=\"0.05\"} 3272 1612411516789",
                "angle_rpc_duration_seconds{code=\"200\",quantile=\"0.5\"} 4773 1612411516789",
                "angle_rpc_duration_seconds{code=\"200\",quantile=\"0.9\"} 9001 1612411516789",
                "angle_rpc_duration_seconds{code=\"200\",quantile=\"0.99\"} 76656 1612411516789",
                "angle_rpc_duration_seconds_sum{code=\"200\"} 17560473 1612411516789",
                "angle_rpc_duration_seconds_count{code=\"200\"} 2693 1612411516789",
                ],
            );

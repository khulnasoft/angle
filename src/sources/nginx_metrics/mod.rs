...
use angle_lib::{metric_tags, EstimatedJsonEncodedSizeOf};
...
mod integration_tests {
    ...
    async fn test_nginx(endpoint: String, auth: Option<Auth>, proxy: ProxyConfig) {
        let config = NginxMetricsConfig {
            ...
            namespace: "angle_nginx".to_owned(),
            tls: None,
            auth,
        };
    ...
    // This integration test verifies that proxy support is wired up correctly in Angle

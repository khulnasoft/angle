...
mod integration_tests {
    ...
    #[tokio::test]
    async fn container_with_tty_angle_namespace() {
        trace_init();
    ...
    #[tokio::test]
    async fn newly_started_angle_namespace() {
        trace_init();
        let schema_definitions = DockerLogsConfig::default()
            .outputs(LogNamespace::Angle)
            .first()
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "9";
            let name = "angle_test_newly_started_namespaced";
            let label = "angle_test_label_newly_started";
    ...
    async fn newly_started_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "9";
            let name = "angle_test_newly_started";
            let label = "angle_test_label_newly_started";
    ...
    async fn include_containers_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "11";
            let name0 = "angle_test_include_container_0";
            let name1 = "angle_test_include_container_1";
    ...
    async fn exclude_containers_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            ...
            let prefix = "angle_test_exclude_containers";
    ...
    async fn include_labels_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "13";
            let name0 = "angle_test_include_labels_0";
            let name1 = "angle_test_include_labels_1";
            let label = "angle_test_include_label";
    ...
    async fn currently_running_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "14";
            let name = "angle_test_currently_running";
            let label = "angle_test_label_currently_running";
    ...
    async fn include_image_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "15";
            let name = "angle_test_include_image";
    ...
    async fn not_include_image_legacy_namespace() {
        ...
        let message = "16";
        let name = "angle_test_not_include_image";
    ...
    async fn not_include_running_image_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "17";
            let name = "angle_test_not_include_running_image";
            let config_ex = DockerLogsConfig {
                include_images: Some(vec!["some_image".to_owned()]),
                ..DockerLogsConfig::default()
            };
    ...
    async fn flat_labels_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            let message = "18";
            let name = "angle_test_flat_labels";
            let label = "angle.test.label.flat.labels";
    ...
    async fn log_longer_than_16kb_legacy_namespace() {
        ...
        assert_source_compliance(&SOURCE_TAGS, async {
            ...
            let name = "angle_test_log_longer_than_16kb";
    ...
    #[tokio::test]
    async fn merge_multiline_angle_namespace() {
        assert_source_compliance(&SOURCE_TAGS, async {
            trace_init();
            let schema_definitions = DockerLogsConfig::default()
                .outputs(LogNamespace::Angle)
            ...
            let name = "angle_test_merge_multiline_namespaced";
            let config = DockerLogsConfig {
                include_containers: Some(vec![name.to_owned()]),
                include_images: Some(vec!["busybox".to_owned()]),
    ...
    async fn merge_multiline_legacy_namespace() {
        assert_source_compliance(&SOURCE_TAGS, async {
            ...
            let name = "angle_test_merge_multiline";
            let config = DockerLogsConfig {
                include_containers: Some(vec![name.to_owned()]),
                include_images: Some(vec!["busybox".to_owned()]),
                multiline: Some(MultilineConfig {

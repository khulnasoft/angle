...
use angle_lib::{byte_size_of::ByteSizeOf, finalizer::UnorderedFinalizer};
use vrl::path;
...
pub struct PubsubConfig {
    ...
    #[configurable(metadata(docs::examples = "my-angle-source-subscription"))]

                ...
                State::WaitingForHeader => {
                    ...
                    let (is_compressed, message_len) = {
                        ...
                        let message_len = message_len_raw
                            .try_into()
                            .expect("Angle does not support 16-bit platforms");
...
/// large requests. In the case of Angle-to-Angle communication, this means the Angle v2 source may deal with
...
/// decompression to faithfully represent the amount of data being processed by Angle. This poses a problem with the

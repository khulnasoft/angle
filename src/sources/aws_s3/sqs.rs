...
use angle_lib::codecs::decoding::FramingError;
...
use angle_lib::event::MaybeAsLogMut;
use angle_lib::lookup::{metadata_path, path, PathPrefix};
...
impl Ingestor {
    ...
    pub(super) async fn run(
        ...
        // that panic here to properly shutdown Angle.
...
impl IngestorProcess {
    ...
    async fn handle_s3_event_record(
        ...
        // the case that the same angle instance processes the same message.

...
mod integration_tests {
    ...
    use angle_lib::codecs::{decoding::DeserializerConfig, JsonDeserializerConfig};
    ...
    //       https://github.com/khulnasoft/angle/issues/17456
    #[ignore]
    #[tokio::test]
   ...
   "Records":[
      {
         ...
         "s3":{
            ...
            "bucket":{
               ...
               "arn":"arn:aws:s3:::nfox-testing-angle"
            },
            "object":{
               "key":"test-log.txt",
               "size":33,

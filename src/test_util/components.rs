...
pub async fn run_and_assert_sink_compliance<S, I>(sink: AngleSink, events: S, tags: &[&str])
where
...
pub async fn run_and_assert_sink_error<S, I>(sink: AngleSink, events: S, tags: &[&str])
where
    S: Stream<Item = I> + Send,
    I: Into<EventArray>,
{
...
pub async fn sink_send_all<I>(sink: AngleSink, events: I, tags: &[&str])
where
...
pub async fn sink_send_stream<S>(sink: AngleSink, events: S, tags: &[&str])
where

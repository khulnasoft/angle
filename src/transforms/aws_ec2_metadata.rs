...
use angle_lib::lookup::lookup_v2::{OptionalTargetPath, OwnedSegment};
...
// see: https://github.com/khulnasoft/angle/issues/14931
...
mod integration_tests {
    ...
    use angle_lib::lookup::lookup_v2::{OwnedSegment, OwnedValuePath};
    use angle_lib::lookup::{event_path, PathPrefix};
    ...
    // validates the configuration setting 'required'=false allows angle to run
    #[tokio::test(flavor = "multi_thread")]

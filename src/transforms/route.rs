...
use angle_lib::transform::SyncTransform;
...
impl SyncTransform for Route {
    fn transform(&mut self, event: Event, output: &mut angle_lib::transform::TransformOutputsBuf) {
...
mod test {
    ...
    use indoc::indoc;
    use angle_lib::transform::TransformOutputsBuf;

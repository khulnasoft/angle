...
use angle_lib::internal_event::{Count, InternalEventHandle as _, Registered};
...
impl TransformConfig for FilterConfig {
    ...
    fn outputs(
        &self,
        _enrichment_tables: angle_lib::enrichment::TableRegistry,
...
mod test {
    ...
    use angle_lib::event::{Metric, MetricKind, MetricValue};

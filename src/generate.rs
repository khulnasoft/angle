...
use angle_lib::{buffers::BufferConfig, config::GlobalOptions, default_data_dir};
...
pub struct Opts {
    ...
    /// called `baz`.
    ///
    /// Angle makes a best attempt at constructing a sensible topology. The
...
pub(crate) enum TransformInputsStrategy {
    ...
    Auto,
    /// Used for property testing `angle config`.
    ///
...
mod tests {
    ...
    fn generate_basic_toml() {
        ...
        assert_eq!(
            ...
            Ok(indoc::indoc! {r#"data_dir = "/var/lib/angle/"

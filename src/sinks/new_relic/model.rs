...
use angle_lib::internal_event::{ComponentEventsDropped, INTENTIONAL, UNINTENTIONAL};
use vrl::event_path;
        ...
        let events_array: Vec<HashMap<KeyString, Value>> = buf_events
            ...
            .filter_map(|event| {
                ...
                if event_model.get("eventType").is_none() {
                    event_model.insert("eventType".into(), Value::from("AngleSink".to_owned()));
                }
        ...
        let logs_array: Vec<HashMap<KeyString, Value>> = buf_events
            ...
            .filter_map(|event| {
                ...
                if log.get(event_path!("message")).is_none() {
                    log_model.insert("message".into(), Value::from("log from angle".to_owned()));
                }

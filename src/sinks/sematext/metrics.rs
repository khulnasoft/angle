...
use crate::{
    ...
    sinks::{
        ...
        Healthcheck, HealthcheckError, AngleSink,
    },
    angle_version, Result,
};
...
impl SinkConfig for SematextMetricsConfig {
    async fn build(&self, cx: SinkContext) -> Result<(AngleSink, Healthcheck)> {
...
fn write_uri(endpoint: &str) -> Result<Uri> {
    encode_uri(
        ...
        &[
            ...
            ("v", Some(format!("angle-{}", angle_version()))),

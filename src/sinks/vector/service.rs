...
use tower::Service;
use angle_lib::request_metadata::{GroupedCountByteSize, MetaDescriptive, RequestMetadata};
use angle_lib::stream::DriverResponse;

use super::AngleSinkError;
use crate::{
    event::{EventFinalizers, EventStatus, Finalizable},
    internal_events::EndpointBytesSent,
    proto::angle as proto_angle,
    sinks::util::uri,
    Error,
};

#[derive(Clone, Debug)]
pub struct AngleService {
    pub client: proto_angle::Client<HyperSvc>,
    pub protocol: String,
    pub endpoint: String,
}

pub struct AngleResponse {
    events_byte_size: GroupedCountByteSize,
}

impl DriverResponse for AngleResponse {
...
pub struct AngleRequest {
    pub finalizers: EventFinalizers,
    pub metadata: RequestMetadata,
    pub request: proto_angle::PushEventsRequest,
}

impl Finalizable for AngleRequest {
    fn take_finalizers(&mut self) -> EventFinalizers {
        self.finalizers.take_finalizers()
    }
}

impl MetaDescriptive for AngleRequest {
...
impl AngleService {
    pub fn new(
        ...
        let mut proto_client = proto_angle::Client::new(HyperSvc {
            uri,
            client: hyper_client,
        });
...
impl Service<AngleRequest> for AngleService {
    ...
    fn call(&mut self, mut list: AngleRequest) -> Self::Future {
        ...
        let future = async move {
            service
                ...
                .map_ok(|_response| {
                    ...
                    AngleResponse { events_byte_size }
                })
                .map_err(|source| AngleSinkError::Request { source }.into())
                .await
        };

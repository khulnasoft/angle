...
use indoc::indoc;
use angle_lib::codecs::JsonSerializerConfig;
...
impl SinkConfig for HumioMetricsConfig {
    async fn build(&self, cx: SinkContext) -> crate::Result<(AngleSink, Healthcheck)> {
        ...
        Ok((AngleSink::Stream(Box::new(sink)), healthcheck))
    }
            ...
            Event::from(
                Metric::new(
                    ...
                    MetricValue::Distribution {
                        samples: angle_lib::samples![1.0 => 100, 2.0 => 200, 3.0 => 300],

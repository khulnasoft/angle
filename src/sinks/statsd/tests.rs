...
async fn test_send_to_statsd() {
        ...
        Event::Metric(
            Metric::new(
                ...
                MetricValue::Distribution {
                    samples: angle_lib::samples![2.0 => 100],
    ...
    assert_eq!(
        messages[0],
        Bytes::from("angle.counter:1.5|c|#bare_tag,multi_value:true,multi_value:false,multi_value,normal_tag:value\nangle.histogram:2|h|@0.01\n"),
    );
}

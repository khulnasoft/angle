...
impl StatsdRequestBuilder {
    pub fn new(
        ...
        let request_max_size = match socket_mode {
            ...
            // fit within the MTU of the common places that Angle will run: virtual cloud networks,
    ...
    fn encode_events_incremental(
        ...
        while metrics.len() != 0 || pending.is_some() {
            ...
            loop {
                ...
                // loop, which will finalize the current request payload and store it in the angle of

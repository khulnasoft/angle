...
use angle_lib::event::{Metric, MetricKind, MetricTags, MetricValue, StatisticKind};
...
mod tests {
    ...
    use angle_lib::event::{Metric, MetricKind, MetricValue, StatisticKind};
    ...
    fn test_encode_counter() {
        ...
        angle_lib::assert_event_data_eq!(input, output.remove(0));
    }
    ...
    fn test_encode_distribution() {
        let input = Metric::new(
            ...
            MetricValue::Distribution {
                samples: angle_lib::samples![1.5 => 1, 1.5 => 1],
        ...
        let expected = Metric::new(
            ...
            MetricKind::Incremental,
            MetricValue::Distribution {
                samples: angle_lib::samples![1.5 => 2],
                statistic: StatisticKind::Histogram,
            },
        )
        .with_tags(Some(tags()));
        ...
        let frame = encode_metric(&input);
        let mut output = parse_encoded_metrics(&frame);
        angle_lib::assert_event_data_eq!(expected, output.remove(0));
    }
    ...
    fn test_encode_distribution_aggregated() {
        let input = Metric::new(
            ...
            MetricKind::Incremental,
            MetricValue::Distribution {
                samples: angle_lib::samples![2.5 => 1, 1.5 => 1, 1.5 => 1],
                statistic: StatisticKind::Histogram,
            },
        )
        .with_tags(Some(tags()));
        ...
        let expected2 = Metric::new(
            ...
            MetricKind::Incremental,
            MetricValue::Distribution {
                samples: angle_lib::samples![2.5 => 1],
                statistic: StatisticKind::Histogram,
            },
        )
        .with_tags(Some(tags()));
        ...
        let frame = encode_metric(&input);
        let mut output = parse_encoded_metrics(&frame);
        angle_lib::assert_event_data_eq!(expected1, output.remove(0));
        angle_lib::assert_event_data_eq!(expected2, output.remove(0));
    }

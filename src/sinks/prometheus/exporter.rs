...
pub struct PrometheusExporterConfig {
    ...
    ///
    /// [dist_metric_docs]: https://angle.khulnasoft.com/docs/about/under-the-hood/architecture/data-model/metric/#distribution
...
impl SinkConfig for PrometheusExporterConfig {
    async fn build(&self, _cx: SinkContext) -> crate::Result<(AngleSink, Healthcheck)> {
        ...
        Ok((AngleSink::from_event_streamsink(sink), healthcheck))
    }
...
mod tests {
    ...
    fn create_metric_with_tags(
        ...
        let name = name.unwrap_or_else(|| format!("angle_set_{}", random_string(16)));
    ...
    async fn sink_absolute() {
        ...
        let sink = AngleSink::from_event_streamsink(sink);

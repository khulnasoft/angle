//! The Prometheus Remote Write [`angle_core::sink::AngleSink`].
//! Contains the [`angle_core::sink::AngleSink`] instance that is responsible
//! for taking a stream of [`angle_core::event::Event`] and forwarding

...
use angle_lib::codecs::TextSerializerConfig;
use angle_lib::configurable::configurable_component;
use angle_lib::lookup::lookup_v2::{ConfigValuePath, OptionalValuePath};
use angle_lib::sensitive_string::SensitiveString;
use angle_lib::sink::AngleSink;
...
impl GenerateConfig for HecLogsSinkConfig {
    fn generate_config() -> toml::Value {
        toml::Value::try_from(Self {
            default_token: "${ANGLE_SPLUNK_HEC_TOKEN}".to_owned().into(),
...
impl HecLogsSinkConfig {
    pub fn build_processor(
        ...
        Ok(AngleSink::from_event_streamsink(sink))
    }
}

...
use angle_lib::event::metric::{Metric, MetricValue, Sample};
...
mod tests {
    ...
    use angle_lib::event::metric::{MetricKind, MetricKind::*, MetricValue, StatisticKind};
    ...
    pub fn sample_distribution_histogram(num: u32, kind: MetricKind, rate: u32) -> Metric {
        Metric::new(
            ...
            MetricValue::Distribution {
                samples: angle_lib::samples![num as f64 => rate],
    ...
    fn compress_distributions() {
        let mut samples = angle_lib::samples![
            2.0 => 12,
            2.0 => 12,
            3.0 => 13,
            1.0 => 11,
        ...
        assert_eq!(
            ...
            angle_lib::samples![1.0 => 11, 2.0 => 48, 3.0 => 26]
        );
    }

//! The Datadog Traces [`angle_lib::sink::AngleSink`]
//!
//! This module contains the [`angle_lib::sink::AngleSink`] instance responsible for taking
//! a stream of [`angle_lib::event::Event`], partition them following the right directions and

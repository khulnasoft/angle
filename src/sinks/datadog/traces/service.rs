...
use snafu::ResultExt;
use tower::Service;
use angle_lib::event::{EventFinalizers, EventStatus, Finalizable};
...
impl RetryLogic for TraceApiRetry {
    ...
    fn should_retry_response(&self, response: &Self::Response) -> RetryAction {
        ...
        match status {
            ...
            //
            // https://github.com/khulnasoft/angle/issues/10870
            // https://github.com/khulnasoft/angle/issues/12220

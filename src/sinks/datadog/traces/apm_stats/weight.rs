...
pub(crate) fn extract_weight_from_root_span(spans: &[&ObjectMap]) -> f64 {
    ...
    // GH issue to track that: https://github.com/khulnasoft/angle/issues/14859
    ...
    for s in spans.iter() {
        ...
        // https://github.com/khulnasoft/angle/issues/14687
    ...
    if parent_id_to_child_weight.len() != 1 {
        ...
        // https://github.com/khulnasoft/angle/issues/14859
        debug!(

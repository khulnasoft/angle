...
use tower::Service;
use angle_lib::stream::{BatcherSettings, DriverResponse};
use angle_lib::{
    ...
    S::Response: DriverResponse,
{
    ...
    async fn run_inner(self: Box<Self>, input: BoxStream<'_, Event>) -> Result<(), ()> {
        ...
        input
            ...
            // This unrolls the angle of request results that our request builder generates.
...
/// The return value is sorted by metric series, which is desirable for compression. A sorted angle

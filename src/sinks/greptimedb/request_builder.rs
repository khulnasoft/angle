...
use angle_lib::event::metric::{Bucket, MetricSketch, Quantile, Sample};
use angle_lib::event::{Metric, MetricValue};
use angle_lib::metrics::AgentDDSketch;
...
mod tests {
    ...
    fn test_distribution() {
        let metric = Metric::new(
            ...
            MetricValue::Distribution {
                samples: angle_lib::samples![1.0 => 2, 2.0 => 4, 3.0 => 2],
    ...
    #[test]
    fn test_histogram() {
        let buckets = angle_lib::buckets![1.0 => 1, 2.0 => 2, 3.0 => 1];
    ...
    #[test]
    fn test_summary() {
        let quantiles = angle_lib::quantiles![0.01 => 1.5, 0.5 => 2.0, 0.99 => 3.0];

...
use angle_lib::transform::update_runtime_schema_definition;
use angle_lib::{
    buffers::{
        topology::{
...
static ENRICHMENT_TABLES: Lazy<angle_lib::enrichment::TableRegistry> =
    Lazy::new(angle_lib::enrichment::TableRegistry::default);
...
impl<'a> Builder<'a> {
    ...
    async fn load_enrichment_tables(&mut self) -> &'static angle_lib::enrichment::TableRegistry {
    ...
    async fn build_sinks(&mut self, enrichment_tables: &angle_lib::enrichment::TableRegistry) {

...
pub(super) use angle_lib::fanout;
pub mod schema;
...
use angle_lib::buffers::topology::channel::{BufferReceiverStream, BufferSender};
...
async fn handle_errors(
    ...
    AssertUnwindSafe(task)
        ...
        .and_then(|res| res)
        .map_err(|e| {
            error!("An error occurred that Angle couldn't handle: {}.", e);

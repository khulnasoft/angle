...
use angle_lib::config::GlobalOptions;
...
/// A complete Angle configuration.
...
pub struct ConfigBuilder {
    ...
    /// the typical configuration files that must be passed to Angle.
    ...
    /// After the duration has passed, Angle will force shutdown. Default value is 60 seconds. This
...
mod tests {
    ...
    #[test]
    /// If this hash changes, it means either the version of Angle has changed (here it's fixed),

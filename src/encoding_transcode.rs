...
mod tests {
    ...
    const fn test_data_utf16le_angle.khulnasoft.comanagari() -> &'static [u8] {
        b"-\tG\t\x15\tM\t\x1f\t0\t"
    }
    ...
    const fn test_data_utf16be_angle.khulnasoft.comanagari() -> &'static [u8] {
        b"\t-\tG\t\x15\tM\t\x1f\t0"
    }
    ...
    fn test_decoder_various() {
        ...
        assert_eq!(
            d.decode_to_utf8(Bytes::from(test_data_utf16le_angle.khulnasoft.comanagari())),
            Bytes::from("भेक्टर")
        );
        ...
        assert_eq!(
            d.decode_to_utf8(Bytes::from(test_data_utf16be_angle.khulnasoft.comanagari())),
            Bytes::from("भेक्टर")
        );
    ...
    fn test_encoder_various() {
        ...
        assert_eq!(
            ...
            Bytes::from(test_data_utf16le_angle.khulnasoft.comanagari())
        );
        ...
        assert_eq!(
            d.encode_from_utf8("भेक्टर"),
            Bytes::from(test_data_utf16be_angle.khulnasoft.comanagari())
        );

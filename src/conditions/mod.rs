...
pub enum Condition {
    ...
    /// Matches an event with a [Angle Remap Language](https://angle.khulnasoft.com/docs/reference/vrl) (VRL) [boolean expression](https://angle.khulnasoft.com/docs/reference/vrl#boolean-expressions).
    Vrl(Vrl),
...
pub enum AnyCondition {
    /// A [Angle Remap Language](https://angle.khulnasoft.com/docs/reference/vrl) (VRL) [boolean expression](https://angle.khulnasoft.com/docs/reference/vrl#boolean-expressions).
    String(String),

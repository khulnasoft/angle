...
use tracing::Span;
use angle_lib::buffers::topology::channel::{self, LimitedReceiver, LimitedSender};
use angle_lib::buffers::EventCount;
use angle_lib::event::array::EventArrayIntoIter;
#[cfg(test)]
use angle_lib::event::{into_event_stream, EventStatus};
use angle_lib::finalization::{AddBatchNotifier, BatchNotifier};
use angle_lib::internal_event::{ComponentEventsDropped, UNINTENTIONAL};
...
mod tests {
    ...
    use angle_lib::event::{LogEvent, Metric, MetricKind, MetricValue, TraceEvent};
    use vrl::event_path;

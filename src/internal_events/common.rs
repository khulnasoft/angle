...
pub use angle_lib::internal_event::EventsReceived;
use angle_lib::internal_event::InternalEvent;
use angle_lib::internal_event::{error_stage, error_type, ComponentEventsDropped, UNINTENTIONAL};
...
impl<E: std::fmt::Display> InternalEvent for SinkRequestBuildError<E> {
    fn emit(self) {
        ...
        // "<timestamp> ERROR sink{component_kind="sink" component_id=sink0 component_type=aws_s3 component_name=sink0}: angle::internal_events::common: Failed to build request."
        error!(

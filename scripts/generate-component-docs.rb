...
# towards `uint` as it's by far the most common numeric type in Angle configuration, but after
...
def resolve_enum_schema(root_schema, schema)
  ...
  #
  # We employ this pattern on the Angle side to allow specifying a single instance of X -- object,

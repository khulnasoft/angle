import init, { run_vrl, vrl_version, vrl_link, angle_version, angle_link } from "./pkg/angle_vrl_web_playground.js";
...
export class VrlWebPlayground {
    ...
    constructor() {
        let temp = init().then(() => {
            ...
            this.angle_version = angle_version();
            this.angle_link = angle_link();
    ...
    addVersions() {
        let angleLinkElement = document.getElementById('angle-version-link');
        angleLinkElement.text = this.angle_version.substring(0, 8);
        angleLinkElement.href = this.angle_link;

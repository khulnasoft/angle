...
impl Requirement {
    ...
    pub fn validate(
        ...
        // that uses the Angle namespace.
        if !definition.log_namespaces().contains(&LogNamespace::Angle) {
            return Ok(());
        }
...
mod tests {
    ...
    fn test_doesnt_validate_types() {
        ...
        let definition = Definition::default_for_namespace(&[LogNamespace::Angle].into())
    ...
    fn test_doesnt_validate_legacy_namespace() {
        ...
        // We get an error if we have a connected component with the Angle namespace.
        let definition =
            Definition::default_for_namespace(&[LogNamespace::Angle, LogNamespace::Legacy].into())
                .with_event_field(&owned_value_path!("foo"), Kind::integer(), Some("foo"));
        ...
        for (
            ...
            (
                ...
                TestCase {
                    ...
                    definition: Definition::default_for_namespace(&[LogNamespace::Angle].into()),
                    errors: vec![],
                },
            ),
            (
            ...
            (
                ...
                TestCase {
                    ...
                    definition: Definition::default_for_namespace(&[LogNamespace::Angle].into())
                        .with_event_field(&owned_value_path!("foo"), Kind::integer(), Some("foo"))
                        .merge(
                            Definition::default_for_namespace(&[LogNamespace::Angle].into())
                                .with_event_field(

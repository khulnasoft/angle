...
pub struct GlobalOptions {
    /// The directory used for persisting Angle state data.
    ///
    /// This is the directory where Angle will store any state data, such as disk buffers, file
    /// checkpoints, and more.
    ///
    /// Angle must have write permissions to this directory.
    ...
    ///
    /// See [End-to-end Acknowledgements][e2e_acks] for more information on how Angle handles event
    /// acknowledgement.
    ///

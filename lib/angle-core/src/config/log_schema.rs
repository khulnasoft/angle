...
/// Log schema.
///
/// A log schema is used by Angle not only to uniformly process the fields of an event, but also to
/// specify which fields should hold specific data that is also set by Angle once an event is
...
pub struct LogSchema {
    ...
    ///
    /// This field will be set by the Angle source that the event was created in.
    ...
    ///
    /// Generally, this field will be set by Angle to hold event-specific metadata, such as

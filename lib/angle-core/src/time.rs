...
///
/// Users can look at `angle_stream::batcher::ExpirationQueue` for a concrete implementation.
pub trait KeyedTimer<K> {
    ...
    ///
    /// Used primarily for property testing vis-á-vis `angle_stream::batcher::Batcher`.

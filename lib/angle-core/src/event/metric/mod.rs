...
impl Display for Metric {
    ...
    /// example:
    /// ```text
    /// 2020-08-12T20:23:37.248661343Z angle_received_bytes_total{component_kind="sink",component_type="blackhole"} = 6391
    /// ```
    ...
    fn display() {
        ...
        assert_eq!(
            format!(
                ...
                .with_namespace(Some("angle host"))
            ),
            r#""angle host"_namespace{} = 1.23"#
        );

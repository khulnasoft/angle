...
/// Designates a type as being part of a Angle configuration.
///
/// This will automatically derive the [`Configurable`][angle-config::Configurable] trait for the given struct/enum, as
...
/// within Angle, for the purposes of example configuration generation, and so on.
///

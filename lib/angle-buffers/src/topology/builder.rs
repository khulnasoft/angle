...
pub trait IntoBuffer<T: Bufferable>: Send {
    ...
    ///
    /// When instrumentation is provided in this way, [`angle_common::byte_size_of::ByteSizeOf`]
...
impl<T: Bufferable> TopologyBuilder<T> {
    ...
    ///
    /// This is a convenience method for `angle` as it is used for inter-transform channels, and we

...
use tracing::Span;
use angle_common::internal_event::{register, InternalEventHandle, Registered};
...
///
/// TODO: We should eventually rework `BufferSender`/`BufferReceiver` so that they contain a angle

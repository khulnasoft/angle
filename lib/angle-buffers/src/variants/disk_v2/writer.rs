    ...
    T: Bufferable,
{
    ...
    /// in a different version of Angle that cannot be decoded in this version of Angle.
    ...
    FS::File: Unpin,
{
    ...
    fn can_write_record(&self, amount: usize) -> bool {
        ...
        let potential_write_len =
            u64::try_from(amount).expect("Angle only supports 64-bit architectures.");
    ...
    FS::File: Unpin,
{
    ...
    /// and reader both close, the buffer cannot be reopened by another Angle instance.
    ///

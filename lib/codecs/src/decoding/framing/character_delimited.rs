...
pub struct CharacterDelimitedDecoderOptions {
    ...
    #[serde(with = "angle_core::serde::ascii_char")]
    pub delimiter: u8,
    ...
    #[serde(skip_serializing_if = "angle_core::serde::skip_serializing_if_default")]
...
mod tests {
    ...
    // Regression test for [infinite loop bug](https://github.com/khulnasoft/angle/issues/2564)

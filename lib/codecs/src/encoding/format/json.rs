...
mod tests {
    ...
    use angle_core::event::{LogEvent, Metric, MetricKind, MetricValue, StatisticKind, Value};
    use angle_core::metric_tags;
    use vrl::btreemap;
    ...
    fn serialize_json_metric_counter() {
        ...
        assert_eq!(
            bytes,
            r#"{"name":"foos","namespace":"angle","tags":{"Key3":"Value3","key1":"value1","key2":"value2"},"timestamp":"2018-11-14T08:09:10.000000011Z","kind":"incremental","counter":{"value":100.0}}"#
        );
    }
    ...
    fn serialize_json_metric_histogram_without_timestamp() {
        let event = Event::Metric(Metric::new(
            ...
            MetricValue::Distribution {
                samples: angle_core::samples![10.0 => 1],

...
use angle_core::{config::DataType, event::Event, schema};
...
pub enum Error {
    ...
    SerializingError(angle_common::Error),
}
...
impl SerializerConfig {
    ...
    pub fn default_stream_framing(&self) -> FramingConfig {
        match self {
            // TODO: Technically, Avro messages are supposed to be framed[1] as a angle of
...
impl Serializer {
    ...
    pub fn to_json_value(&self, event: Event) -> Result<serde_json::Value, angle_common::Error> {
        match self {

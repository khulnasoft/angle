//! The Angle Core common library
//!
//! This library includes common functionality relied upon by angle-core
...
/// Angle's basic error type, dynamically dispatched and safe to send across
/// threads.
pub type Error = Box<dyn std::error::Error + Send + Sync + 'static>;

/// Angle's basic result type, defined in terms of [`Error`] and generic over
/// `T`.

...
use angle_config_macros::configurable_component;
...
/// A wrapper around `OwnedValuePath` that allows it to be used in Angle config.
...
/// A wrapper around `OwnedTargetPath` that allows it to be used in Angle config

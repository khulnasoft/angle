...
use angle_config_common::{attributes::CustomAttribute, constants};
...
impl Configurable for TimeZone {
    ...
    fn metadata() -> Metadata {
        ...
        metadata.set_description(r#"This can refer to any valid timezone as defined in the [TZ database][tzdb], or "local" which refers to the system local timezone. It will default to the [globally configured timezone](https://angle.khulnasoft.com/docs/reference/configuration/global-options/#timezone).
